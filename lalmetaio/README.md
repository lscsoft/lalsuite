...
If you make use of the [Python/Octave interfaces to LALMetaIO][swiglal], please
...
In addition, some codes contained in LALMetaIO may be directly based on one or
