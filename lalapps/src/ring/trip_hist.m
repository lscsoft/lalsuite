...
% Sarah Caudill, Nov 16th 2009
  ...
  eval(['plothist(veto_level, coinctype, ifo1, ifo2, ''' H1bgfile ''', nonbgtype, ''' H1nonbgfile ''');'])
  ...
  eval(['background_param_plots( veto_level, coinctype, ''H1'', ''H2'', ''' H1bgfile ''', ''' H2bgfile ''');'])
  eval(['background_param_plots( veto_level, coinctype, ''H1'', ''L1'', ''' H1bgfile ''', ''' L1bgfile ''');'])
  eval(['background_param_plots( veto_level, coinctype, ''H2'', ''L1'', ''' H2bgfile ''', ''' L1bgfile ''');'])
