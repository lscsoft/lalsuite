...
set -x
${builddir}/lalapps_Weave --output-file=WeaveOut.fits --output-toplist-limit=5000 --output-per-detector --output-per-segment --output-info-per-seg --setup-file=WeaveSetup.fits \
