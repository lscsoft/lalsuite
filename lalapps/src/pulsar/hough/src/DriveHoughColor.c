...
#define ACCURACY 0.01 /* of the velocity calculation */
...
int main(int argc, char *argv[]){
  ...
  {  
	...
	if ( argc > arg + 1 ) {
      ...
      /* Parse Running median window size and normalization factor. */
 ...
 */
  ...
  /******************************************************************/  
  /* opening the output statistic file */
  /******************************************************************/  
