...
BASENAME = 'crab_H1H2L1_3_ul'; %Name to be appended to all the output files
STARTINGDIR = '/archive/home/josephb/searches2/crab_H1H2L1_3_ul/';  %Directory where the starting files and executables are
WORKINGDIR = '/usr1/josephb/upper_limit'; %Directory on the individual node where temporary files will be kept
CODEFILENAME = strcat([STARTINGDIR,'/','Upper_Limit_V2.py']);  %Name of the python script to run
INIFILENAME = strcat([STARTINGDIR,'/','crab_H1H2L1_3_MC.ini']); %Name of the initialization file which sets the parameters the python script uses
