...
extern int write_toplist_to_fp(toplist_t*, FILE*);
...
extern int read_toplist_from_fp(toplist_t*, FILE*);
...
extern int write_toplist_item_to_fp(FstatsClusterOutput,FILE*);
...
extern int atomic_write_toplist_to_file(toplist_t*,char*);
