...
params->meshCosIota[2]*(iPhase + params->meshPhase[2]*iPsi));     
         ...
         ci = params->meshCosIota[0] + (REAL8)iCosIota*params->meshCosIota[1];
         iota = acos(ci);
...
exp(-(iota-IOTAMEAN)*(iota-IOTAMEAN)/(2.*IOTASIGMA*IOTASIGMA));
         ...
         output->pdf->data[iH0] += exp((input->chiSquare -
input->mChiSquare->data[arg])/2.0) * prior;
       }
...
exp(-(iota-IOTAMEAN)*(iota-IOTAMEAN)/(2.*IOTASIGMA*IOTASIGMA));
         ...
         output->pdfPsi->data[iPsi] += exp((input->chiSquare -
input->mChiSquare->data[arg])/2.0) * prior;      
       }  
...
exp(-(iota-IOTAMEAN)*(iota-IOTAMEAN)/(2.*IOTASIGMA*IOTASIGMA));        
         ...
         output->pdfPhase->data[iPhase] += exp((input->chiSquare -
input->mChiSquare->data[arg])/2.0) * prior;      
       }
...
exp(-(iota-IOTAMEAN)*(iota-IOTAMEAN)/(2.*IOTASIGMA*IOTASIGMA));         
         ...
         output->pdfCosIota->data[iCosIota] += exp((input->chiSquare -
input->mChiSquare->data[arg])/2.0) * prior;      
       }
