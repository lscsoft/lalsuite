...
my $Tsft = 1800.0;
my $dur = 40551300.0;
my $skygrid = "/home/egoetz/TwoSpect/UL_spindowns/skygrid.dat";
for(my $ii=0; $ii<10; $ii++) {
   ...
   my $f1dot = sprintf("%.6e", 1.0e-9*rand()-5.0e-10);
...
timestampsFile /home/egoetz/TwoSpect/UL_spindowns/timestamps.dat
generationMode 0
fmin 401.0
Band 2.9992
Tsft 1800
...
EOF
   ...
   open(INJECTION, ">>/home/egoetz/TwoSpect/UL_spindowns/$jobnum/injections.dat") or die "Cannot write to /home/egoetz/TwoSpect/UL_spindowns/$jobnum/injections.dat $!";
   print INJECTION "$alpha $delta $h0 $psi $phi0 $f1dot $f0 $P $df\n";
   close(INJECTION);
...
ephemDir /home/egoetz/TwoSpect/S6
ephemYear 08-11-DE405
outdirectory /home/egoetz/TwoSpect/UL_spindowns/$jobnum
sftType standard
IFO H1
FFTplanFlag 1
fastchisqinv
