...
system("mkdir /local/user/egoetz/$pidvalue");
die "mkdir failed: $?" if $?;

my $h0ul = 4.5709e-24;
my $Tsft = 1800.0;
my $dur = 40551300.0;
my $skygrid = "/home/egoetz/TwoSpect/UL_eccOrbits/skygrid.dat";
...
#startTime 931081500
#duration 40551300
timestampsFile /home/egoetz/TwoSpect/UL_eccOrbits/timestamps.dat
generationMode 0
fmin 401.0
Band 2.9992
Tsft 1800
...
EOF
   ...
   open(INJECTION, ">>/home/egoetz/TwoSpect/UL_eccOrbits/$jobnum/injections.dat") or die "Cannot write to /home/egoetz/TwoSpect/UL_eccOrbits/$jobnum/injections.dat $!";
   print INJECTION "$alpha $delta $h0 $psi $phi0 $f0 $P $df $ecc $argp\n";
   close(INJECTION);
...
ephemDir /home/egoetz/TwoSpect/S6
ephemYear 08-11-DE405
outdirectory /home/egoetz/TwoSpect/UL_eccOrbits/$jobnum
sftType standard
IFO H1
markBadSFTs
FFTplanFlag 1
