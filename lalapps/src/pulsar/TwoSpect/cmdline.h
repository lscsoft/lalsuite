...
struct gengetopt_args_info
{
  ...
  double ra_arg;	/**< @brief Right ascension of sky position to search in radians.  */
  char * ra_orig;	/**< @brief Right ascension of sky position to search in radians original value given at command line.  */
  const char *ra_help; /**< @brief Right ascension of sky position to search in radians help description.  */
  double dec_arg;	/**< @brief Declination of sky position to search in radians.  */
  char * dec_orig;	/**< @brief Declination of sky position to search in radians original value given at command line.  */
  const char *dec_help; /**< @brief Declination of sky position to search in radians help description.  */
  ...
  double P0_arg;	/**< @brief Frequency independent spectral density.  */
  char * P0_orig;	/**< @brief Frequency independent spectral density original value given at command line.  */
  const char *P0_help; /**< @brief Frequency independent spectral density help description.  */
  double Pslope_arg;	/**< @brief Slope of spectral density (default='0.0').  */
  char * Pslope_orig;	/**< @brief Slope of spectral density original value given at command line.  */
  const char *Pslope_help; /**< @brief Slope of spectral density help description.  */
  double Pquad_arg;	/**< @brief Quadratic coefficient of spectral density (default='0.0').  */
  char * Pquad_orig;	/**< @brief Quadratic coefficient of spectral density original value given at command line.  */
  const char *Pquad_help; /**< @brief Quadratic coefficient of spectral density help description.  */
  ...
  int removeSFTs_arg;	/**< @brief Randomly remove SFTs (default='0').  */
  char * removeSFTs_orig;	/**< @brief Randomly remove SFTs original value given at command line.  */
  const char *removeSFTs_help; /**< @brief Randomly remove SFTs help description.  */
  int varySFTs_arg;	/**< @brief Randomly vary SFT noise background (default='0').  */
  char * varySFTs_orig;	/**< @brief Randomly vary SFT noise background original value given at command line.  */
  const char *varySFTs_help; /**< @brief Randomly vary SFT noise background help description.  */
  ...
  unsigned int ra_given ;	/**< @brief Whether ra was given.  */
  unsigned int dec_given ;	/**< @brief Whether dec was given.  */
  ...
  unsigned int Pslope_given ;	/**< @brief Whether Pslope was given.  */
  unsigned int Pquad_given ;	/**< @brief Whether Pquad was given.  */
  unsigned int blksize_given ;	/**< @brief Whether blksize was given.  */
  unsigned int removeSFTs_given ;	/**< @brief Whether removeSFTs was given.  */
  unsigned int varySFTs_given ;	/**< @brief Whether varySFTs was given.  */
