...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->Tobs_help = gengetopt_args_info_help[3] ;
  args_info->Tcoh_help = gengetopt_args_info_help[4] ;
  args_info->t0_help = gengetopt_args_info_help[5] ;
  args_info->fmin_help = gengetopt_args_info_help[6] ;
  args_info->fspan_help = gengetopt_args_info_help[7] ;
  args_info->Pmin_help = gengetopt_args_info_help[8] ;
  args_info->Pmax_help = gengetopt_args_info_help[9] ;
  args_info->dfmin_help = gengetopt_args_info_help[10] ;
  args_info->dfmax_help = gengetopt_args_info_help[11] ;
  args_info->ihsfar_help = gengetopt_args_info_help[12] ;
  args_info->tmplfar_help = gengetopt_args_info_help[13] ;
  args_info->avesqrtSh_help = gengetopt_args_info_help[14] ;
  args_info->blksize_help = gengetopt_args_info_help[15] ;
  args_info->outdirectory_help = gengetopt_args_info_help[16] ;
  args_info->sftDir_help = gengetopt_args_info_help[17] ;
  args_info->ephemDir_help = gengetopt_args_info_help[18] ;
