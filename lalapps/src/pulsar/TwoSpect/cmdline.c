...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[70] = 0; 
  
}

const char *gengetopt_args_info_help[71];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->injRandSeed_help = gengetopt_args_info_full_help[69] ;
  args_info->weightedIHS_help = gengetopt_args_info_full_help[71] ;
  args_info->signalOnly_help = gengetopt_args_info_full_help[72] ;
  args_info->templateTest_help = gengetopt_args_info_full_help[73] ;
  args_info->templateTestF_help = gengetopt_args_info_full_help[74] ;
  args_info->templateTestP_help = gengetopt_args_info_full_help[75] ;
  args_info->templateTestDf_help = gengetopt_args_info_full_help[76] ;
  args_info->bruteForceTemplateTest_help = gengetopt_args_info_full_help[77] ;
  ...
  args_info->printSignalData_help = gengetopt_args_info_full_help[91] ;
  args_info->printMarginalizedSignalData_help = gengetopt_args_info_full_help[92] ;
