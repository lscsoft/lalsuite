...
const char *gengetopt_args_info_help[] = {
  ...
  "      --ra=DOUBLE               Right ascension of sky position to search in \n                                  radians",
  "      --dec=DOUBLE              Declination of sky position to search in \n                                  radians",
  "      --cols=INT                Maximum column width to search",
  "      --ihsfar=DOUBLE           IHS FAR threshold  (default=`0.01')",
  "      --P0=DOUBLE               Frequency independent spectral density",
  "      --Pslope=DOUBLE           Slope of spectral density  (default=`0.0')",
  "      --Pquad=DOUBLE            Quadratic coefficient of spectral density  \n                                  (default=`0.0')",
  "      --blksize=INT             Blocksize for running median of 1st FFT band  \n                                  (default=`1001')",
  "      --removeSFTs=INT          Randomly remove SFTs  (default=`0')",
  "      --varySFTs=INT            Randomly vary SFT noise background  \n                                  (default=`0')",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ra_given = 0 ;
  args_info->dec_given = 0 ;
  args_info->cols_given = 0 ;
  args_info->ihsfar_given = 0 ;
  args_info->P0_given = 0 ;
  args_info->Pslope_given = 0 ;
  args_info->Pquad_given = 0 ;
  args_info->blksize_given = 0 ;
  args_info->removeSFTs_given = 0 ;
  args_info->varySFTs_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ra_orig = NULL;
  args_info->dec_orig = NULL;
  args_info->cols_orig = NULL;
  args_info->ihsfar_arg = 0.01;
  args_info->ihsfar_orig = NULL;
  args_info->P0_orig = NULL;
  args_info->Pslope_arg = 0.0;
  args_info->Pslope_orig = NULL;
  args_info->Pquad_arg = 0.0;
  args_info->Pquad_orig = NULL;
  args_info->blksize_arg = 1001;
  args_info->blksize_orig = NULL;
  args_info->removeSFTs_arg = 0;
  args_info->removeSFTs_orig = NULL;
  args_info->varySFTs_arg = 0;
  args_info->varySFTs_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ra_help = gengetopt_args_info_help[12] ;
  args_info->dec_help = gengetopt_args_info_help[13] ;
  args_info->cols_help = gengetopt_args_info_help[14] ;
  args_info->ihsfar_help = gengetopt_args_info_help[15] ;
  args_info->P0_help = gengetopt_args_info_help[16] ;
  args_info->Pslope_help = gengetopt_args_info_help[17] ;
  args_info->Pquad_help = gengetopt_args_info_help[18] ;
  args_info->blksize_help = gengetopt_args_info_help[19] ;
  args_info->removeSFTs_help = gengetopt_args_info_help[20] ;
  args_info->varySFTs_help = gengetopt_args_info_help[21] ;
  args_info->outdirectory_help = gengetopt_args_info_help[22] ;
  args_info->ephemDir_help = gengetopt_args_info_help[23] ;
  args_info->dopplerMultiplier_help = gengetopt_args_info_help[24] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->ra_orig));
  free_string_field (&(args_info->dec_orig));
  free_string_field (&(args_info->cols_orig));
  free_string_field (&(args_info->ihsfar_orig));
  free_string_field (&(args_info->P0_orig));
  free_string_field (&(args_info->Pslope_orig));
  free_string_field (&(args_info->Pquad_orig));
  free_string_field (&(args_info->blksize_orig));
  free_string_field (&(args_info->removeSFTs_orig));
  free_string_field (&(args_info->varySFTs_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ra_given)
    write_into_file(outfile, "ra", args_info->ra_orig, 0);
  if (args_info->dec_given)
    write_into_file(outfile, "dec", args_info->dec_orig, 0);
  ...
  if (args_info->P0_given)
    write_into_file(outfile, "P0", args_info->P0_orig, 0);
  if (args_info->Pslope_given)
    write_into_file(outfile, "Pslope", args_info->Pslope_orig, 0);
  if (args_info->Pquad_given)
    write_into_file(outfile, "Pquad", args_info->Pquad_orig, 0);
  if (args_info->blksize_given)
    write_into_file(outfile, "blksize", args_info->blksize_orig, 0);
  if (args_info->removeSFTs_given)
    write_into_file(outfile, "removeSFTs", args_info->removeSFTs_orig, 0);
  if (args_info->varySFTs_given)
    write_into_file(outfile, "varySFTs", args_info->varySFTs_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Right ascension of sky position to search in radians.  */
          else if (strcmp (long_options[option_index].name, "ra") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ra_arg), 
                 &(args_info->ra_orig), &(args_info->ra_given),
                &(local_args_info.ra_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "ra", '-',
                additional_error))
              goto failure;
          ...
          /* Declination of sky position to search in radians.  */
          else if (strcmp (long_options[option_index].name, "dec") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->dec_arg), 
                 &(args_info->dec_orig), &(args_info->dec_given),
                &(local_args_info.dec_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "dec", '-',
                additional_error))
              goto failure;
          ...
          /* Frequency independent spectral density.  */
          else if (strcmp (long_options[option_index].name, "P0") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->P0_arg), 
                 &(args_info->P0_orig), &(args_info->P0_given),
                &(local_args_info.P0_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "P0", '-',
                additional_error))
              goto failure;
          ...
          /* Slope of spectral density.  */
          else if (strcmp (long_options[option_index].name, "Pslope") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->Pslope_arg), 
                 &(args_info->Pslope_orig), &(args_info->Pslope_given),
                &(local_args_info.Pslope_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "Pslope", '-',
                additional_error))
              goto failure;
          ...
          /* Quadratic coefficient of spectral density.  */
          else if (strcmp (long_options[option_index].name, "Pquad") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->Pquad_arg), 
                 &(args_info->Pquad_orig), &(args_info->Pquad_given),
                &(local_args_info.Pquad_given), optarg, 0, "0.0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "Pquad", '-',
                additional_error))
              goto failure;
          ...
          /* Randomly remove SFTs.  */
          else if (strcmp (long_options[option_index].name, "removeSFTs") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->removeSFTs_arg), 
                 &(args_info->removeSFTs_orig), &(args_info->removeSFTs_given),
                &(local_args_info.removeSFTs_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "removeSFTs", '-',
                additional_error))
              goto failure;
          ...
          /* Randomly vary SFT noise background.  */
          else if (strcmp (long_options[option_index].name, "varySFTs") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->varySFTs_arg), 
                 &(args_info->varySFTs_orig), &(args_info->varySFTs_given),
                &(local_args_info.varySFTs_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "varySFTs", '-',
                additional_error))
              goto failure;
