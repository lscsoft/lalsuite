...
int main(void)
{
   ...
   REAL4Vector *floatvalues1 = XLALCreateREAL4Vector(length);
   REAL8Vector *doublevalues1 = XLALCreateREAL8Vector(length);
   REAL4Vector *floatvalues2 = XLALCreateREAL4Vector(length);
   REAL8Vector *doublevalues2 = XLALCreateREAL8Vector(length);
   REAL4VectorSequence *floatvalues = XLALCreateREAL4VectorSequence(2, length);
   ...
   REAL4Vector *floatresult_exp = XLALCreateREAL4Vector(floatvalues1->length);
   REAL8Vector *doubleresult_exp = XLALCreateREAL8Vector(doublevalues1->length);
   REAL4Vector *floatresult_vecsum = XLALCreateREAL4Vector(floatvalues1->length);
   REAL4Vector *floatresult_vecmult = XLALCreateREAL4Vector(floatvalues1->length);
   REAL4Vector *floatresult_addscalar = XLALCreateREAL4Vector(floatvalues1->length);
   REAL4Vector *floatresult_scale = XLALCreateREAL4Vector(floatvalues1->length);
   REAL8Vector *doubleresult_addscalar = XLALCreateREAL8Vector(doublevalues1->length);
   REAL8Vector *doubleresult_scale = XLALCreateREAL8Vector(doublevalues1->length);
   REAL4Vector *floatresult_sin2pix = XLALCreateREAL4Vector(floatvalues1->length);
   REAL4Vector *floatresult_cos2pix = XLALCreateREAL4Vector(floatvalues1->length);
   REAL8Vector *doubleresult_sin2pix = XLALCreateREAL8Vector(doublevalues1->length);
   REAL8Vector *doubleresult_cos2pix = XLALCreateREAL8Vector(doublevalues1->length);
   REAL4VectorSequence *sequencesumresult = XLALCreateREAL4VectorSequence(2, length);
   REAL4Vector *sequencesubtractresult = XLALCreateREAL4Vector(length);
   memset(sequencesumresult->data, 0, sizeof(REAL4)*2*length);

   sse_exp_REAL4Vector(floatresult_exp, floatvalues1);
   sse_exp_REAL8Vector(doubleresult_exp, doublevalues1);

   sseSSVectorSum(floatresult_vecsum, floatvalues1, floatvalues2);
   sseSSVectorMultiply(floatresult_vecmult, floatvalues1, floatvalues2);
   sseAddScalarToREAL4Vector(floatresult_addscalar, floatvalues1, (REAL4)100.0);
   sseScaleREAL4Vector(floatresult_scale, floatvalues1, (REAL4)100.0);

   sseAddScalarToREAL8Vector(doubleresult_addscalar, doublevalues1, 100.0);
   sseScaleREAL8Vector(doubleresult_scale, doublevalues1, 100.0);

   sse_sin_cos_2PI_LUT_REAL4Vector(floatresult_sin2pix, floatresult_cos2pix, floatvalues2);
   sse_sin_cos_2PI_LUT_REAL8Vector(doubleresult_sin2pix, doubleresult_cos2pix, doublevalues2);

   sseSSVectorSequenceSum(sequencesumresult, floatvalues, floatvalues, 0, 1, 0, 1);
   sseSSVectorSequenceSubtract(sequencesubtractresult, floatvalues, floatvalues2, 0);
