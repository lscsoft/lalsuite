/*
  ...
  gengetopt --file-name=cmdline_skygridsetup --conf-parser --show-required=[required]
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->SFToverlap_help = gengetopt_args_info_help[4] ;
  args_info->t0_help = gengetopt_args_info_help[5] ;
  args_info->Tobs_help = gengetopt_args_info_help[6] ;
  args_info->fmin_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->v2_given)
    write_into_file(outfile, "v2", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Start time of the search, needed only if --v2 is specified (in GPS seconds).  */
          ...
          /* Total observation time, needed only if --v2 is specified (in seconds).  */
          ...
          else if (strcmp (long_options[option_index].name, "outfilename") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->outfilename_arg), 
                ...
                &(local_args_info.outfilename_given), optarg, 0, "skygrid.dat", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "outfilename", '-',
                additional_error))
              goto failure;
          ...
          /* Flag to use the newer style of CompDetectorVmax input arguments (always specify this unless you know what you are doing!).  */
          else if (strcmp (long_options[option_index].name, "v2") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->v2_flag), 0, &(args_info->v2_given),
                &(local_args_info.v2_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "v2", '-',
                additional_error))
              goto failure;
