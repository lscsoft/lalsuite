...
#   lalapps_create_solar_system_ephemeris --verbose --test no longer compares equal against this file, presumably because there have been
...
lalapps_create_solar_system_ephemeris --verbose --test
