...
/****************************************************************/
/*                                                              */
/* START FUNCTION: RunStackSlideIsolatedMonteCarloSimulationOld */
/* Injects fake signals and runs Monte Carlo simulation.        */
/*                                                              */
/****************************************************************/
void RunStackSlideIsolatedMonteCarloSimulationOld(LALStatus *status, StackSlideSearchParams *params, INT4 nSamples)
{
  ...
  INITSTATUS( status, "RunStackSlideIsolatedMonteCarloSimulationOld", STACKSLIDEISOLATEDC );
  ATTATCHSTATUSPTR(status);
...
/**************************************************************/
/*                                                            */
/* END FUNCTION: RunStackSlideIsolatedMonteCarloSimulationOld */
/* Injects fake signals and runs Monte Carlo simulation.      */
/*                                                            */
/**************************************************************/
#endif
