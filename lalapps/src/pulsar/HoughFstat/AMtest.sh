...
while [ $j -lt $top ] ; do
	...
	./HoughValidateAM -E ./earth00-40-DE405.dat -S ./sun00-40-DE405.dat -D $sftdir -r $alpha -l $delta -m $h0 -c $cosiota -M $mismatch >> $outfile

	# if we want cosiota at a fixed value
	#./HoughValidateAM -E ./earth00-40-DE405.dat -S ./sun00-40-DE405.dat -D $sftdir -r $alpha -l $delta -m $h0 -c 0.5 -p $psi -M $mismatch >> $outfile
