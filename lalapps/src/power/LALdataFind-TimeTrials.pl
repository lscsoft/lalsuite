...
my $PLOT_FILE  =  "/home/dsmackin/public_html/plots/time_to_run_laldatafind.png";
...
my @lengths = qw(500 1000 5000 10000 12000 50000 100000);
...
print PLOT_FILE << "PLOT_COMMANDS";
	...
	set title "Cache File Time Length Optimization (first second in test $startEpoch; tested on Hydra)"
	set xlabel "Number of Seconds in Cache File"
	set xtics ($xtics)
	set ylabel "Time to Run"
	set data style lp
	plot "$DATA_FILE" using 1:2 t "LALdataFind"
