...
white-noise burst waveforms originating from the direction of the galactic
core.  These populations are selected with the \option{--population}
option.  Each population required additional parameters to characterize it,
and other command line options are associated with these.
...
injection is the equivalent isotropic radiated energy for an isolated
source.  The value given on the command line is the energy in solar masses
divided by the square of the distance to the source in parsecs.
...
Select the injection population.  The allowed names are
\option{galactic\_core}, \option{string\_cusp},
\option{all\_sky\_sinegaussian}.
