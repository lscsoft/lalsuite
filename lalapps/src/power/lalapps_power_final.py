...
def mu_p_epsilon(xi, p):
	...
	for (\mu_{p} \epsilon), the product of the foreground rate upper
	limit times the efficiency.  Note that this product is always well
	defined by this relation (i.e., even when the efficiency is 0).
	"""
	def f(mue):
