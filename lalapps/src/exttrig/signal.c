...
int XLALMakeSineGaussian( REAL8TimeSeries **hplus, REAL8TimeSeries **hcross, LIGOTimeGPS *epoch, REAL8 deltaT, REAL8 Q, REAL8 f0, REAL8 hrss, REAL8 eccentricity, REAL8 polarization )
{
	LIGOTimeGPS start;
