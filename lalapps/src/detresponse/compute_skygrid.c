/*
*  Copyright (C) 2007 Badri Krishnan, Duncan Brown, David Chin, Patrick Brady, Vladimir Dergachev
*
...
static double doppler(REAL8         velocity[3],  
                     ...
                     skygrid_t grid_sum_sq, skygrid_t grid_relfreq)
{
  ...
  { 
        ...
        args_info.sampling_interval_given)
    {
      ...
      time_interval = args_info.sampling_interval_arg;
    }
    else
    {
    ...
    for (j = start_ra; j < end_ra; ++j)
    {
      ...
      for (i = start_dec; i < end_dec; ++i)
      {
        ...
        */
        ...
        grid_relfreq->data[cnt] = doppler(det_velocity, &(source.equatorialCoords));
      }
    }
