...
\author{Marc van der Sluys$^1$, Vivien Raymond$^2$, Ilya Mandel$^2$ \\
  \small$^1$University of Alberta, $^2$Northwestern University \\
  \small\texttt{\href{http://www.phys.ualberta.ca/~sluys/index.php?title=SPINspiral}{http://www.phys.ualberta.ca/$\sim$sluys/index.php?title=SPINspiral}}}
...
\texttt{\href{http://www.phys.ualberta.ca/~sluys/index.php?page=Public/svn-howto}{http://www.phys.ualberta.ca/$\sim$sluys/index.php?page=Public/svn-howto}}.  
