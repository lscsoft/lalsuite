...
openmpirun -np 4 ./lalinference_mcmcmpi --IFO [H1] --cache [LALLIGO] --PSDstart 864161757.0 --PSDlength 1000 --srate 1024 --seglen 10 --trigtime 864162757.0 --injXML test.xml
