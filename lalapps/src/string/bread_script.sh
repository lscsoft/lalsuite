...
cp coincidences/H1*H1L1*M* H1ctriggers/
cp coincidences/H1*H1L1*P* H1ctriggers/
...
cp coincidences/H2*H2L1*M* H2ctriggers/
cp coincidences/H2*H2L1*P* H2ctriggers/
...
cp coincidences/L1*L1H1*M* L1ctriggers/
cp coincidences/L1*L1H1*P* L1ctriggers/
