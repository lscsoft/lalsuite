...
The excess-power method relies on having a time-frequency
...
infinite extent and can lead to data corruption of the band-passed
data stream when contructed as described above.   We can,  however,
start from this and construct a filter which preferentially
...
\section{Program \texttt{lalapps\_binj}}
