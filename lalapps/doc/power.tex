...
certain stages of the analysis.
...
quarter the window length (i.e.\ half the length of data that is actually
analyzed).  For example, if you wish the code to analyze the data in 1
second windows, you need to set this parameter to the number of samples
corresponding to 2 seconds of data.
