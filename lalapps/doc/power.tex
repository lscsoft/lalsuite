...
\item[\option{--input} \parm{filename}]
The infile should be a txt file, say file.txt which will contain the list
of xml files. \prog{lalapps\_bread} reads in triggers from those xml files
which are listed in file.txt
