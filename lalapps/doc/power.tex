...
\begin{equation}
\sigma^2(k_0,  2b) = \sigma^2(k_0,  b) + \sigma^2(k_0+b,  b) + 2\sum_{k=0}^{N-1}\tilde{\Theta}_k^\ast(k_0,  b)\tilde{\Theta}_k^\ast(k_0,  b)
\label{eq:norm}
\end{equation}

Now,  the filter being orthogonal(almost),  the cross term in Eq~\ref{eq:norm} will be negligible.  
