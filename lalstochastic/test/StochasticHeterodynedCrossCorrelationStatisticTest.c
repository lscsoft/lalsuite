...
int main( int argc, char *argv[] )
{
  ...
  if ( ( fabsf(crealf(output.value)/STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_EXP1)
	 > STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_TOL )
       || ( fabsf((cimagf(output.value) - STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_EXP1)
		 / STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_EXP1)
	    > STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_TOL )
       )
  {
  ...
  if ( ( fabsf(crealf(output.value)-STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_EXP2)
         / STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_EXP2
         > STOCHASTICHETERODYNEDCROSSCORRELATIONSTATISTICTESTC_TOL )
