...
\latexonly
\footnote{The values are compared to a series generated by Matlab, correcting for the differing sign convention.}
\endlatexonly
\if HTML
   ...
   for (i=1; i<CZEROPADANDFFTTESTC_FULLLENGTH; ++i)
   {
     ...
     if (optVerbose)
     {
       printf("hBarTilde(%f Hz)=%g + %g i, should be %g + %g i\n",
              ...
              crealf(expectedOutputDataData[i]), expectedOutputDataData[i].im);
     }
