...
set -x
lalpulsar_WeaveSetup --ephem-earth=earth00-40-DE405.dat.gz --ephem-sun=sun00-40-DE405.dat.gz --first-segment=1122332211/90000 --detectors=H1,L1 --output-file=WeaveSetup.fits
...
set -x
env LAL_DEBUG_LEVEL="${LAL_DEBUG_LEVEL},info" lalpulsar_WeaveCompare --setup-file=WeaveSetup.fits --result-file-1=WeaveOut.fits --result-file-2=RefWeaveOut.fits --round-param-to-n-sf=4 --unmatched-item-tol=0.5
set +x
echo
