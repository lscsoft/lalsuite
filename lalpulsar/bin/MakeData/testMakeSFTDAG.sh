...
pubSFTopts="-O 4 -K DEV -V 1"
cmdline="lalpulsar_MakeSFTDAG ${pubSFTopts} -f test.dag -G TEST -d H1_HOFT_C00 -k 7 -T ${Tsft} -p . -N H1:GDS-CALIB_STRAIN_CLEAN -F ${fmin} -B ${Band} -w 3 -P 0.5 -m 1 -A ligo.sim.o4.cw.explore.test -U albert.einstein -g segs -J /tmp/path/to"
...
RETRY MakeSFTs_1 5
VARS MakeSFTs_1 argList=\"${pubSFTopts} -f 7 -t 1800 -p . -C cache/H-1257741529-1257743329.cache -s 1257741529 -e 1257743329 -N H1:GDS-CALIB_STRAIN_CLEAN -F 10 -B 1990 -w 3 -P 0.5\" tagstring=\"TEST_1\"
...
RETRY MakeSFTs_2 5
VARS MakeSFTs_2 argList=\"${pubSFTopts} -f 7 -t 1800 -p . -C cache/H-1257743330-1257745130.cache -s 1257743330 -e 1257745130 -N H1:GDS-CALIB_STRAIN_CLEAN -F 10 -B 1990 -w 3 -P 0.5\" tagstring=\"TEST_2\"
