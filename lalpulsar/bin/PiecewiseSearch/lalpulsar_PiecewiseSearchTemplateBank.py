...
parser.add_argument("--kmin",           type=float,     help="Set the kmin parameter",                                                  nargs='?', const=1, default=-1)
parser.add_argument("--kmax",           type=float,     help="Set the kmax parameter",                                                  nargs='?', const=1, default=-1)
...
if kmin     != -1:    tbank.kmin     = kmin
if kmax     != -1:    tbank.kmax     = kmax
if dur      != -1:    tbank.dur      = dur
if mismatch != -1:    tbank.maxmismatch = mismatch
...
if knots != [0]:
        ...
        ek.allidealisedknots(tbank.s, tbank.dur, 40, tbank.fmax, tbank.nmax, tbank.kmin, tbank.maxmismatch)
