...
///
/// Compute a lower-triangular basis matrix whose columns are orthonormal with respect to a given
/// metric.
///
...
/// neighbours of a nearest point found with LT_FindNearestPoint().
///
