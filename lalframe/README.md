...
If you make use of the [Python/Octave interfaces to LALFrame][swiglal], please
...
In addition, some codes contained in LALFrame may be directly based on one or
