...
def parse_command_line():
    ...
    parser.add_option(
        ...
        type="float",
        default=9.0,
        help='Set the time window used by the "inspiral" match algorithm (default = 9.0).',
    )
...
search = {"inspiral": "inspiral"}[options.match_algorithm]
