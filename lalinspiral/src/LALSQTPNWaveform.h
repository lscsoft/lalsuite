...
typedef struct tagLALSQTPNWaveformParams{
	...
	LALInspiralInteraction interaction; ///< which spin interaction will be included in the generation
 ...
 * \f$\hat{L_N}_y\f$, \f$\hat{L_N}_z\f$, \f$\Phi\f$] are calculated by the XLALSQTPNDerivator() function.
