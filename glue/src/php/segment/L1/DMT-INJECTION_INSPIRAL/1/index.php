...
$com = "ldbdc --query \"select segment.start_time,segment.end_time from segment,segment_definer where segment.segment_def_id=segment_definer.segment_def_id and segment.segment_def_cdb=segment_definer.creator_db and segment.start_time>=931035615 and segment_definer.version=1 and segment_definer.name='DMT-INJECTION_INSPIRAL' and segment_definer.ifos='L1' order by segment.start_time ASC\" 2>&1";
