...
<body id="sum_list" onLoad="clear_form('sum_list_form')">
...
<form name="sum_list_form" id="sum_list_form" method="GET" action="sum_list.php">
This tool lists all the currently available summary intervals for the given flag type in the segment database.<p/>
