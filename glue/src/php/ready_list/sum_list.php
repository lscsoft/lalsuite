...
$pieces = explode(":", $in);
echo "<b>summary intervals of " .$in . "</b><br/>";
...
$com = "ldbdc --segment-url $segment_url --query \"select segment_summary.start_time,segment_summary.end_time from segment_summary,segment_definer where segment_summary.segment_def_id=segment_definer.segment_def_id and segment_summary.segment_def_cdb=segment_definer.creator_db and segment_summary.start_time>=931035615 and segment_definer.version=$pieces[2] and segment_definer.name='$pieces[1]' and segment_definer.ifos='$pieces[0]' order by segment_summary.start_time ASC\"";
