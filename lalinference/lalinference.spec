...
Requires: gsl libmetaio lal lalmetaio lalinspiral lalpulsar
Prefix: %{_prefix}
...
Requires: gsl-devel libmetaio-devel lal-devel lalmetaio-devel lalinspiral lalinspiral-devel lalpulsar lalpulsar-devel
%description devel
The LSC Algorithm Inference Library for gravitational wave data analysis. This
