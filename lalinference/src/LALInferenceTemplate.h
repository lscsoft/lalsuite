...
SWIGLAL(
    FUNCTION_POINTER(
        ...
        LALInferenceTemplateXLALSimBlackHoleRingdown,
 ...
 * 	generated by LALSimBlackHoleRingdownTiger.
 *  
F * Required ( \c IFOdata->modelParams ) parameters are:
I * - \c "rdmass"           (REAL8, mass of final BH, solar masses)
X * - \c "inclination"  (REAL8, inclination angle, radians)
M * - \c "coa_phase"    (REAL8, phase angle, radians)
E * - \c "rdspin"       (REAL8, x component of the spin of object 1)
! * - \c "shift0"       (REAL8, shift offset, radians)
! * - \c "time"         (REAL8, coalescence time, or equivalent/analog/similar, GPS seconds)
! * - \c "PNorder"      (REAL8, Phase PN order)
 * - \c "
