 ...
 */
typedef enum {
  LALINFERENCE_INT4_t = LAL_I4_TYPE_CODE,
  LALINFERENCE_INT8_t = LAL_I8_TYPE_CODE,
  LALINFERENCE_UINT4_t = LAL_U4_TYPE_CODE,
  LALINFERENCE_REAL4_t = LAL_S_TYPE_CODE,
  LALINFERENCE_REAL8_t = LAL_D_TYPE_CODE,
  LALINFERENCE_COMPLEX8_t = LAL_C_TYPE_CODE,
  LALINFERENCE_COMPLEX16_t = LAL_Z_TYPE_CODE,
  /* The following are not basic LAL types
   * Start enumerating at 0100 */
  LALINFERENCE_gslMatrix_t = 0100,
  LALINFERENCE_REAL8Vector_t = 0101,
  LALINFERENCE_INT4Vector_t = 0102,
  LALINFERENCE_UINT4Vector_t = 0103,
  LALINFERENCE_COMPLEX16Vector_t = 0104,
  LALINFERENCE_string_t = 0105,
  LALINFERENCE_MCMCrunphase_ptr_t = 0106,
  LALINFERENCE_void_ptr_t = 0107
