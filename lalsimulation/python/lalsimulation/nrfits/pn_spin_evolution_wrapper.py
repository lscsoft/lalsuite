...
def spin_evolution(
    q, chiA0, chiB0, omega0, approximant="SpinTaylorT4", dt=0.1, spinO=6, phaseO=7
):
    """
    ...
    m1_SI = M * MSUN_SI * q / (1.0 + q)
    m2_SI = M * MSUN_SI / (1.0 + q)
    ...
    V, Phi, S1x, S1y, S1z, S2x, S2y, S2z, LNhatx, LNhaty, LNhatz, E1x, E1y, E1z = (
        lalsim.SimInspiralSpinTaylorPNEvolveOrbit(
            deltaT,
            m1_SI,
            m2_SI,
            fStart,
