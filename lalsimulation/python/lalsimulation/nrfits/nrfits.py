...
class NRFits(object):
    ...
    # ------------------------------------------------------------------------
    def __call__(
        self, m1, m2, chiA_vec, chiB_vec, f_ref, fit_types_list, extra_params_dict
    ):
        ...
        fit_params = self._get_fit_params(
            m1, m2, chiA_vec, chiB_vec, f_ref, extra_params_dict
        )
        ...
        for fit_type in fit_types_list:
            ...
            return_dict[fit_type] = self._eval_fit(
                fit_params, fit_type, extra_params_dict
            )
