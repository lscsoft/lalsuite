/*
 * Copyright (C) 2011 E. Ochsner, 2012 Andrew Lundgren
 *
...
#define LALSIMINSPIRAL_ST2_TEST_ENERGY 			1025
#define LALSIMINSPIRAL_ST2_TEST_OMEGADOT 		1026
#define LALSIMINSPIRAL_ST2_TEST_COORDINATE 		1027
#define LALSIMINSPIRAL_ST2_TEST_OMEGANAN 		1028
#define LALSIMINSPIRAL_ST2_TEST_FREQBOUND 		1029
#define LALSIMINSPIRAL_ST2_DERIVATIVE_OMEGANONPOS 	1030
...
#define LAL_NUM_ST2_VARIABLES 14
...
#define LAL_ST2_ABSOLUTE_TOLERANCE 1.e-12
#define LAL_ST2_RELATIVE_TOLERANCE 1.e-12
 ...
 */
typedef struct tagXLALSimInspiralSpinTaylorT2Coeffs
{
...
} XLALSimInspiralSpinTaylorT2Coeffs;

/* Declarations of static functions - defined below */
static int XLALSimInspiralSpinTaylorT2StoppingTest(double t, 
 ...
 * the \"TaylorT2\" approximant for solving the orbital dynamics 
...
{
    INT4 intreturn;
    XLALSimInspiralSpinTaylorT2Coeffs params;/* Frequently used coefficients */
    ark4GSLIntegrator *integrator = NULL;     /* GSL integrator object */
    REAL8 yinit[LAL_NUM_ST2_VARIABLES];       /* initial values of parameters */
    ...
    memset(&params, 0, sizeof(XLALSimInspiralSpinTaylorT2Coeffs));
    ...
    integrator = XLALAdaptiveRungeKutta4Init(LAL_NUM_ST2_VARIABLES,
            XLALSimInspiralSpinTaylorT2Derivatives,
            XLALSimInspiralSpinTaylorT2StoppingTest,
            LAL_ST2_ABSOLUTE_TOLERANCE, LAL_ST2_RELATIVE_TOLERANCE);
    if( !integrator )
    {
    ...
    if (intreturn != 0 && intreturn != LALSIMINSPIRAL_ST2_TEST_ENERGY 
            && intreturn != LALSIMINSPIRAL_ST2_TEST_OMEGADOT 
            && intreturn != LALSIMINSPIRAL_ST2_TEST_FREQBOUND)
    {
 ...
 */
static int XLALSimInspiralSpinTaylorT2StoppingTest(
	double t, 
	const double values[],
	double dvalues[], 
	void *mparams
	)
{
    ...
    XLALSimInspiralSpinTaylorT2Coeffs *params 
            = (XLALSimInspiralSpinTaylorT2Coeffs*) mparams;
	...
	) 
{
    ...
    {
        return LALSIMINSPIRAL_ST2_DERIVATIVE_OMEGANONPOS;
    }
	...
	)
{
    ...
    if( fRef == 0. )
    {
        ...
        n = XLALSimInspiralPNEvolveOrbitSpinTaylorT2(&V, &Phi, 
    ...
    else /* Start in middle, integrate backward and forward, stitch together */
    {
        ...
        fS = fRef;
        fE = fStart;
        n = XLALSimInspiralPNEvolveOrbitSpinTaylorT2(&V1, &Phi1, 
        ...
        fS = fRef;
        fE = 0.;
        n = XLALSimInspiralPNEvolveOrbitSpinTaylorT2(&V2, &Phi2, 
