...
#include "LALSimEccIMRpD_internals.h"
 ...
 *
 * ADDED:
 * Leading-order eccentricity corrections up to 3PN phase order in TaylorF2 phasing
 * Defined in LALSimInspiralEccentricPhasingCoeffs.c 
 * Based on arXiv:1602.03081
 *
 */
static double EccPhiInsAnsatzInt(double Mf, UsefulPowers * powers_of_Mf, PhiInsPrefactors * prefactors, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
  ...
  // (For the time being, eccentric contributions to PN phasing assembled as in EccTF2 inspiral approximant)
  const double v2 = v * v;
  ...
  if(XLALIsREAL8FailNaN(LO_ecc_corr)) {
		XLALPrintError("LO_ecc_corr is NAN\n");
...
/**
 * First frequency derivative of EccPhiInsAnsatzInt
 */
static double EccDPhiInsAnsatzInt(double Mf, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3) {
  double sigma1 = p->sigma1;
  double sigma2 = p->sigma2;
  double sigma3 = p->sigma3;
  double sigma4 = p->sigma4;
  ...
  if(XLALIsREAL8FailNaN(D_LO_ecc_corr)) {
                XLALPrintError("D_LO_ecc_corr is NAN\n");
		XLAL_ERROR_REAL8(XLAL_EFUNC);
  }
...
static void ComputeEccIMRPhenDPhaseConnectionCoefficients(IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
  ...
  double DPhiIns = EccDPhiInsAnsatzInt(p->fInsJoin, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3);
  ...
  p->C1Int = EccPhiInsAnsatzInt(p->fInsJoin, &powers_of_fInsJoin, prefactors, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3)
...
static double EccIMRPhenDPhase(double f, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, UsefulPowers *powers_of_f, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3)
{
  ...
  if (!StepFunc_boolean(f, p->fInsJoin))	// Inspiral range
  {
	  double PhiIns = EccPhiInsAnsatzInt(f, powers_of_f, prefactors, p, pn, pfv19by3, pfv25by3, pfv28by3, pfv31by3, pfv34by3, pfv37by3);
	  return PhiIns;
  }
