...
//    const UINT4 lmModes[5][2] = {{2, 2}, {2, 1}, {3, 3}, {4, 4}, {5, 5}};
  ...
  INT4 modeL;
  INT4 modeM;
  UINT4 currentModeProv; /*TO DELETE WHEN I WILL PUT THE FOR */
...
/*  memset( tmpValues->data, 0, tmpValues->length*sizeof(tmpValues->data[0]));*/
  ...
  /* Populate the high SR hamiltonian and frequency, rough estimation of the peak of orbital frequency */
  REAL8 omegaOld = 0.0;
  INT4 phaseCounter = 0;
  for (i = 0; i < retLen; i++)
    {
