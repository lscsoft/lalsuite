const double sigmaKerrdata1prm  =  1.0;
const double sigmaStardata1prm  =  mass2overmass1;
const double s1dots1prm  =  2*s1Vec->data[1];
const double sKerrUSCOREyprm  =  sigmaKerrdata1prm;
const double sStarUSCOREyprm  =  sigmaStardata1prm;
const double a2prm  =  2*sKerrUSCOREy*sKerrUSCOREyprm;
...
const double deltaSigmaStarUSCOREy1prm  =  etaover12r*(sKerrUSCOREy*sKerrmultfactprm + sKerrmultfact*sKerrUSCOREyprm + sStarUSCOREy*sStarmultfactprm + sStarmultfact*sStarUSCOREyprm);
...
const double deltaSigmaStarUSCOREy2prm  =  deltaSigmaStarUSCOREy1prm + sMultiplier2*sigmaKerrdata1prm + sMultiplier1*sigmaStardata1prm + sigmaStar->data[1]*sMultiplier1prm + sigmaKerr->data[1]*sMultiplier2prm;
...
const double deltaSigmaStarUSCOREy3prm  =  deltaSigmaStarUSCOREy2prm + coeffs->d1*etau3*sigmaStardata1prm;
...
const double deltaSigmaStarUSCOREyprm  =  deltaSigmaStarUSCOREy3prm + coeffs->d1v2*etau3*sigmaKerrdata1prm;
const double deltaSigmaStarUSCOREzprm  =  deltaSigmaStarUSCOREz3prm;
const double sxprm  =  deltaSigmaStarUSCORExprm;
const double syprm  =  deltaSigmaStarUSCOREyprm + sStarUSCOREyprm;
...
const double sKerrdotsStarprm  =  sStarUSCOREy*sKerrUSCOREyprm + sKerrUSCOREy*sStarUSCOREyprm;
