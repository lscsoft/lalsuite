const double sigmaKerrdata2prm  =  1.0;
const double sigmaStardata2prm  =  mass2overmass1;
const double s1dots1prm  =  2*s1Vec->data[2];
const double sKerrUSCOREzprm  =  sigmaKerrdata2prm;
const double sStarUSCOREzprm  =  sigmaStardata2prm;
const double a2prm  =  2*sKerrUSCOREz*sKerrUSCOREzprm;
...
const double deltaSigmaStarUSCOREz1prm  =  etaover12r*(sKerrUSCOREz*sKerrmultfactprm + sKerrmultfact*sKerrUSCOREzprm + sStarUSCOREz*sStarmultfactprm + sStarmultfact*sStarUSCOREzprm);
...
const double deltaSigmaStarUSCOREz2prm  =  deltaSigmaStarUSCOREz1prm + sMultiplier2*sigmaKerrdata2prm + sMultiplier1*sigmaStardata2prm + sigmaStar->data[2]*sMultiplier1prm + sigmaKerr->data[2]*sMultiplier2prm;
...
const double deltaSigmaStarUSCOREz3prm  =  deltaSigmaStarUSCOREz2prm + coeffs->d1*etau3*sigmaStardata2prm;
...
const double deltaSigmaStarUSCOREzprm  =  deltaSigmaStarUSCOREz3prm + coeffs->d1v2*etau3*sigmaKerrdata2prm;
const double sxprm  =  deltaSigmaStarUSCORExprm;
const double syprm  =  deltaSigmaStarUSCOREyprm;
const double szprm  =  deltaSigmaStarUSCOREzprm + sStarUSCOREzprm;
...
const double sKerrdotsStarprm  =  sStarUSCOREz*sKerrUSCOREzprm + sKerrUSCOREz*sStarUSCOREzprm;
