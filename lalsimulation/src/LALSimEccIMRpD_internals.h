#ifndef _LALSIM_IMR_ECCIMRPD_INTERNALS_H
#define _LALSIM_IMR_ECCIMRPD_INTERNALS_H
 ...
 *
 * only declared here, defined in LALSIMEccIMRpD.c (because this c file is "included" like an h file)
 */
...
static double EccPhiInsAnsatzInt(double f, UsefulPowers * powers_of_Mf, PhiInsPrefactors * prefactors, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
static double EccDPhiInsAnsatzInt(double ff, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
...
static void ComputeEccIMRPhenDPhaseConnectionCoefficients(IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
static double EccIMRPhenDPhase(double f, IMRPhenomDPhaseCoefficients *p, PNPhasingSeries *pn, UsefulPowers *powers_of_f, PhiInsPrefactors * prefactors, PNPhasingSeries *pfv19by3, PNPhasingSeries *pfv25by3, PNPhasingSeries *pfv28by3, PNPhasingSeries *pfv31by3, PNPhasingSeries *pfv34by3, PNPhasingSeries *pfv37by3);
