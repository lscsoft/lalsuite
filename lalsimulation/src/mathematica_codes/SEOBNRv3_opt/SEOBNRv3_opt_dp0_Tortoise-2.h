...
REAL8 tmp62=tmp10*tmp61*x->data[1];
REAL8 tmp63=e3_z*tmp10*x->data[0];
REAL8 tmp64=-(e3_x*tmp10*x->data[2]);
...
REAL8 tmp68=1/tmp31;
REAL8 tmp50=1/tmp49;
REAL8 tmp69=p->data[0]*tmp67;
REAL8 tmp70=tmp10*tmp65*x->data[0];
REAL8 tmp71=-(tmp10*tmp13*x->data[1]);
REAL8 tmp72=tmp70+tmp71;
REAL8 tmp73=p->data[2]*tmp72;
REAL8 tmp74=-(tmp10*tmp61*x->data[0]);
REAL8 tmp75=tmp10*tmp13*x->data[2];
REAL8 tmp76=tmp74+tmp75;
REAL8 tmp77=p->data[1]*tmp76;
REAL8 tmp78=tmp69+tmp73+tmp77;
REAL8 tmp93=4.+tmp85;
...
REAL8 tmp130=-1440.*tmp126*tmp127*tmp128*tmp129*tmp94*tmp97*tmp98*x->data[0];
...
REAL8 tmp148=12.*tmp147*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
REAL8 tmp149=tmp130+tmp134+tmp139+tmp143+tmp148;
REAL8 tmp151=3240.*tmp126*tmp127*tmp128*tmp129*tmp94*tmp97*tmp98*x->data[0];
...
REAL8 tmp165=-12.*tmp164*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
REAL8 tmp166=tmp151+tmp155+tmp159+tmp160+tmp165;
REAL8 tmp192=sqrt(tmp54);
REAL8 tmp119=-72.*sigmaKerr->data[0]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
REAL8 tmp120=-60.*sigmaStar->data[0]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
...
REAL8 tmp170=-72.*sigmaKerr->data[1]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
REAL8 tmp171=-60.*sigmaStar->data[1]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
...
REAL8 tmp180=-72.*sigmaKerr->data[2]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
REAL8 tmp181=-60.*sigmaStar->data[2]*tmp24*tmp47*tmp55*tmp84*tmp9*tmp91*x->data[0];
...
REAL8 tmp315=tmp13*tmp232;
REAL8 tmp316=tmp245*tmp65;
REAL8 tmp317=tmp258*tmp61;
REAL8 tmp318=tmp315+tmp316+tmp317;
REAL8 tmp320=tmp232*tmp67;
REAL8 tmp321=tmp245*tmp76;
REAL8 tmp322=tmp258*tmp72;
...
REAL8 tmp305=tmp13*tmp168;
REAL8 tmp306=tmp178*tmp65;
REAL8 tmp307=tmp188*tmp61;
0]))+tmp197*tmp20*tmp395*tmp52*tmp55*tmp56*tmp68*(-(tmp104*tmp121*tmp14*tmp194*tmp197*tmp201*tmp273*tmp28*tmp31*tmp396*tmp398*tmp4*tmp50*tmp80)-tmp104*tmp14*tmp194*tmp197*tmp269*tmp28*tmp31*tmp396*tmp398*tmp4*tmp400*tmp50*tmp80-tmp13*tmp14*tmp194*tmp197*tmp273*tmp28*tmp31*tmp396*tmp398*tmp4*tmp400*tmp50*tmp80+tmp304*(-0.5*tmp104*tmp192*tmp197*tmp283*tmp313*tmp405*tmp408*tmp80-0.25*tmp104*tmp121*tmp192*tmp197*tmp201*tmp323*tmp405*tmp408*tmp80-0.5*tmp13*tmp192*tmp197*tmp283*tmp323*tmp405*tmp408*tmp80+tmp194*(tmp194*tmp308*tmp431+1.*tmp104*tmp121*tmp192*tmp197*tmp201*tmp323*tmp427*tmp80+tmp104*tmp192*tmp197*tmp313*tmp400*tmp427*tmp80+tmp13*tmp192*tmp197*tmp323*tmp400*tmp427*tmp80+tmp194*tmp318*tmp415*tmp67*tmp80+tmp194*tmp308*tmp415*tmp78*tmp80+tmp194*tmp318*(0.5*tmp121*tmp201*tmp429-tmp10*tmp28*tmp31*tmp4*tmp55*x->data[0]+tmp282*(tmp415*tmp67*tmp80-tmp427*tmp67*tmp80+tmp10*tmp31*tmp421*x->data[0])))))-tmp197*tmp20*tmp297*tmp462*tmp52*tmp55*tmp56*tmp68*(1.0/(tmp288*tmp288))+(0.5*tmp58*(tmp105+tmp79+tmp92+8.*eta*tmp93*tmp94*tmp95*tmp96*tmp97*tmp98*tmp99*x->data[0]))/sqrt(tmp116)))/sqrt(1.+2.*eta*(-1.-2.*tmp201*tmp207*tmp24*tmp277*tmp278*tmp279*tmp28*tmp280*tmp281*tmp284*tmp337*tmp47+0.5*tmp201*tmp278*tmp279*tmp280*tmp281*tmp284*tmp304*tmp368*tmp392*tmp68+tmp197*tmp20*tmp395*tmp462*tmp52*tmp55*tmp56*tmp68+2.*tmp260*tmp5*tmp50*tmp80+tmp104*tmp192*tmp199*tmp201*tmp260*tmp50*tmp68*tmp80+2.*tmp104*tmp5*tmp50*tmp9+coeffs->dheffSSv2*eta*tmp35*(s1Vec->data[0]*s1Vec->data[0]+s1Vec->data[1]*s1Vec->data[1]+s1Vec->data[2]*s1Vec->data[2]+s2Vec->data[0]*s2Vec->data[0]+s2Vec->data[1]*s2Vec->data[1]+s2Vec->data[2]*s2Vec->data[2])-0.5*tmp37*(tmp232*tmp232+tmp245*tmp245+tmp258*tmp258-3.*(tmp273*tmp273))+tmp58*sqrt(tmp116)));
