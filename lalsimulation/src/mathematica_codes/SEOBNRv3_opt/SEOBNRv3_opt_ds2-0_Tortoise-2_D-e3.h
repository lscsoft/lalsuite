...
REAL8 tmp247=mass2*s1Vec->data[1]*tmp246;
REAL8 tmp248=1/mass2;
REAL8 tmp249=mass1*s2Vec->data[1]*tmp248;
...
REAL8 tmp267=-1440.*tmp185*tmp206*tmp210*tmp211*tmp214*tmp265*tmp63*tmp7;
...
REAL8 tmp286=12.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp283*tmp7;
...
REAL8 tmp291=3240.*tmp185*tmp206*tmp210*tmp211*tmp214*tmp265*tmp63*tmp7;
...
REAL8 tmp307=-12.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp304*tmp7;
REAL8 tmp308=tmp289+tmp290+tmp291+tmp295+tmp299+tmp300+tmp305+tmp306+tmp307;
REAL8 tmp333=mass2*s1Vec->data[0]*tmp246;
REAL8 tmp334=mass1*s2Vec->data[0]*tmp248;
...
REAL8 tmp245=-36.*eta*tmp150*tmp194*tmp201*tmp244*tmp55*tmp63*tmp9*tmp94;
REAL8 tmp251=-30.*eta*tmp150*tmp194*tmp201*tmp244*tmp250*tmp55*tmp63*tmp94;
REAL8 tmp252=36.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp244*tmp63*tmp9;
...
REAL8 tmp255=-60.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp250*tmp7;
REAL8 tmp257=3.*tmp243*tmp256*tmp9;
...
REAL8 tmp309=0.006944444444444444*tmp308*tmp53*tmp9;
REAL8 tmp310=tmp260+tmp288+tmp309;
REAL8 tmp311=1.*tmp17*tmp25*tmp310;
...
REAL8 tmp319=-72.*tmp11*tmp115*tmp150*tmp194*tmp201*tmp243*tmp7;
REAL8 tmp320=-60.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp315*tmp7;
...
REAL8 tmp332=-36.*eta*tmp150*tmp194*tmp201*tmp244*tmp55*tmp63*tmp7*tmp94;
REAL8 tmp336=-30.*eta*tmp150*tmp194*tmp201*tmp244*tmp335*tmp55*tmp63*tmp94;
REAL8 tmp337=36.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp244*tmp63*tmp7;
REAL8 tmp338=30.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp244*tmp335*tmp63;
REAL8 tmp339=-72.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp8;
REAL8 tmp340=-60.*tmp115*tmp150*tmp194*tmp201*tmp243*tmp335*tmp7;
...
REAL8 tmp343=3.*tmp243*tmp256*tmp7;
...
REAL8 tmp449=2.*tmp115*tmp144*tmp149*tmp7;
REAL8 tmp450=tmp446+tmp447+tmp448+tmp449;
REAL8 tmp457=tmp26*tmp310*x->data[1];
REAL8 tmp458=tmp26*tmp327*x->data[2];
REAL8 tmp459=tmp26*tmp369*x->data[0];
REAL8 tmp460=tmp457+tmp458+tmp459;
REAL8 tmp564=coeffs->k5l*tmp91;
REAL8 tmp565=c0k5+tmp564+tmp71+tmp73;
REAL8 tmp537=tmp310*tmp33;
REAL8 tmp538=tmp29*tmp327;
REAL8 tmp539=tmp369*tmp37;
REAL8 tmp540=tmp135*tmp382;
REAL8 tmp541=tmp141*tmp396;
REAL8 tmp542=tmp129*tmp410;
REAL8 tmp543=tmp537+tmp538+tmp539+tmp540+tmp541+tmp542;
REAL8 tmp548=tmp178*tmp310;
REAL8 tmp549=tmp174*tmp327;
REAL8 tmp550=tmp170*tmp369;
REAL8 tmp551=tmp165*tmp382;
REAL8 tmp552=tmp157*tmp396;
...
REAL8 tmp534=2.*tmp115*tmp201*tmp7;
...
REAL8 tmp634=4.*c1k2*tmp7;
REAL8 tmp635=6.*c1k3*tmp7;
...
REAL8 tmp771=-8.*tmp115*tmp243*tmp7;
REAL8 tmp772=2.*tmp587*tmp7;
