...
REAL8 tmp122=-(p->data[0]*tmp59*x->data[0]*x->data[1]);
REAL8 tmp123=-(p->data[1]*tmp59*tmp9);
REAL8 tmp124=-(p->data[2]*tmp59*x->data[1]*x->data[2]);
REAL8 tmp125=p->data[1]*tmp19;
...
REAL8 tmp188=-6.*eta*tmp181*tmp55*x->data[1];
REAL8 tmp189=-12.*eta*tmp57*x->data[1];
REAL8 tmp190=tmp188+tmp189;
REAL8 tmp191=1/tmp184;
REAL8 tmp222=sqrt(tmp11);
REAL8 tmp136=-(tmp19*tmp97*x->data[2]);
REAL8 tmp137=tmp102*tmp19*x->data[1];
REAL8 tmp138=-(tmp22*tmp59*tmp9);
REAL8 tmp139=tmp19*tmp22;
REAL8 tmp140=tmp26*tmp59*x->data[1]*x->data[2];
REAL8 tmp141=tmp136+tmp137+tmp138+tmp139+tmp140;
REAL8 tmp142=p->data[0]*tmp141;
REAL8 tmp143=-(tmp102*tmp19*x->data[0]);
REAL8 tmp144=tmp107*tmp19*x->data[2];
REAL8 tmp145=tmp22*tmp59*x->data[0]*x->data[1];
REAL8 tmp146=-(tmp30*tmp59*x->data[1]*x->data[2]);
REAL8 tmp147=tmp143+tmp144+tmp145+tmp146;
REAL8 tmp148=p->data[1]*tmp147;
REAL8 tmp149=tmp19*tmp97*x->data[0];
REAL8 tmp150=-(tmp107*tmp19*x->data[1]);
REAL8 tmp151=-(tmp26*tmp59*x->data[0]*x->data[1]);
REAL8 tmp152=tmp30*tmp59*tmp9;
REAL8 tmp153=-(tmp19*tmp30);
REAL8 tmp154=tmp149+tmp150+tmp151+tmp152+tmp153;
REAL8 tmp155=p->data[2]*tmp154;
...
REAL8 tmp179=2.*tmp116*tmp135*tmp175*x->data[1];
...
REAL8 tmp196=2.*tmp116*tmp180*tmp186*tmp43*tmp82*x->data[1];
...
REAL8 tmp202=2.*tmp110*tmp115*tmp135*tmp197*x->data[1];
...
REAL8 tmp266=-2160.*tmp133*tmp174*tmp255*tmp256*tmp258*tmp259*tmp265*x->data[1];
REAL8 tmp270=2.*tmp222*tmp237*tmp269;
REAL8 tmp271=2.*tmp19*tmp240*tmp269*x->data[1];
REAL8 tmp274=2.*eta*tmp11*tmp237*tmp240*tmp273;
REAL8 tmp276=2.*eta*tmp273*tmp275*x->data[1];
REAL8 tmp280=tmp222*tmp237*tmp279;
REAL8 tmp281=tmp19*tmp240*tmp279*x->data[1];
...
REAL8 tmp293=18.*tmp116*tmp180*tmp186*tmp222*tmp287*tmp43*tmp82*x->data[1];
...
REAL8 tmp310=4860.*tmp133*tmp174*tmp255*tmp256*tmp258*tmp259*tmp265*x->data[1];
REAL8 tmp314=4.*tmp222*tmp237*tmp313;
REAL8 tmp315=4.*tmp19*tmp240*tmp313*x->data[1];
REAL8 tmp316=-90.*eta*tmp11*tmp237*tmp240;
REAL8 tmp317=-90.*eta*tmp275*x->data[1];
REAL8 tmp321=tmp222*tmp237*tmp320;
REAL8 tmp322=tmp19*tmp240*tmp320*x->data[1];
...
REAL8 tmp334=-18.*tmp116*tmp180*tmp186*tmp222*tmp328*tmp43*tmp82*x->data[1];
...
REAL8 tmp223=-3.*coeffs->d1v2*eta*sigmaKerr->data[0]*tmp55*x->data[1];
...
REAL8 tmp235=-108.*sigmaKerr->data[0]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp236=-90.*sigmaStar->data[0]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp238=3.*sigmaKerr->data[0]*tmp222*tmp237;
REAL8 tmp239=4.*sigmaStar->data[0]*tmp222*tmp237;
REAL8 tmp241=3.*sigmaKerr->data[0]*tmp19*tmp240*x->data[1];
REAL8 tmp242=4.*sigmaStar->data[0]*tmp19*tmp240*x->data[1];
...
REAL8 tmp252=-0.08333333333333333*eta*tmp251*tmp59*x->data[1];
REAL8 tmp295=-0.013888888888888888*sigmaStar->data[0]*tmp294*tmp39;
REAL8 tmp304=0.027777777777777776*sigmaStar->data[0]*tmp303*tmp57*x->data[1];
REAL8 tmp336=0.006944444444444444*sigmaKerr->data[0]*tmp335*tmp39;
REAL8 tmp344=-0.013888888888888888*sigmaKerr->data[0]*tmp343*tmp57*x->data[1];
REAL8 tmp345=tmp223+tmp244+tmp252+tmp295+tmp304+tmp336+tmp344;
REAL8 tmp346=e3_x*tmp345;
REAL8 tmp347=-3.*coeffs->d1v2*eta*sigmaKerr->data[1]*tmp55*x->data[1];
...
REAL8 tmp358=-108.*sigmaKerr->data[1]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp359=-90.*sigmaStar->data[1]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp360=3.*sigmaKerr->data[1]*tmp222*tmp237;
REAL8 tmp361=4.*sigmaStar->data[1]*tmp222*tmp237;
REAL8 tmp362=3.*sigmaKerr->data[1]*tmp19*tmp240*x->data[1];
REAL8 tmp363=4.*sigmaStar->data[1]*tmp19*tmp240*x->data[1];
...
REAL8 tmp373=-0.08333333333333333*eta*tmp372*tmp59*x->data[1];
REAL8 tmp374=-0.013888888888888888*sigmaStar->data[1]*tmp294*tmp39;
REAL8 tmp375=0.027777777777777776*sigmaStar->data[1]*tmp303*tmp57*x->data[1];
REAL8 tmp376=0.006944444444444444*sigmaKerr->data[1]*tmp335*tmp39;
REAL8 tmp377=-0.013888888888888888*sigmaKerr->data[1]*tmp343*tmp57*x->data[1];
REAL8 tmp378=tmp347+tmp365+tmp373+tmp374+tmp375+tmp376+tmp377;
REAL8 tmp379=e3_y*tmp378;
REAL8 tmp380=-3.*coeffs->d1v2*eta*sigmaKerr->data[2]*tmp55*x->data[1];
...
REAL8 tmp391=-108.*sigmaKerr->data[2]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp392=-90.*sigmaStar->data[2]*tmp116*tmp180*tmp186*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp393=3.*sigmaKerr->data[2]*tmp222*tmp237;
REAL8 tmp394=4.*sigmaStar->data[2]*tmp222*tmp237;
REAL8 tmp395=3.*sigmaKerr->data[2]*tmp19*tmp240*x->data[1];
REAL8 tmp396=4.*sigmaStar->data[2]*tmp19*tmp240*x->data[1];
...
REAL8 tmp406=-0.08333333333333333*eta*tmp405*tmp59*x->data[1];
REAL8 tmp407=-0.013888888888888888*sigmaStar->data[2]*tmp294*tmp39;
REAL8 tmp408=0.027777777777777776*sigmaStar->data[2]*tmp303*tmp57*x->data[1];
REAL8 tmp409=0.006944444444444444*sigmaKerr->data[2]*tmp335*tmp39;
REAL8 tmp410=-0.013888888888888888*sigmaKerr->data[2]*tmp343*tmp57*x->data[1];
...
REAL8 tmp458=2.*tmp43*tmp82*x->data[1];
...
REAL8 tmp467=2.*tmp110*tmp115*tmp43*tmp82*x->data[1];
...
REAL8 tmp478=-(tmp430*tmp59*x->data[0]*x->data[1]);
REAL8 tmp479=-(tmp436*tmp59*tmp9);
REAL8 tmp480=tmp19*tmp436;
REAL8 tmp481=-(tmp442*tmp59*x->data[1]*x->data[2]);
...
REAL8 tmp588=tmp147*tmp436;
REAL8 tmp589=tmp154*tmp442;
...
REAL8 tmp569=2.*tmp186*tmp43*tmp82*x->data[1];
...
REAL8 tmp696=2.*tmp17*tmp59*tmp82*x->data[1];
REAL8 tmp697=2.*tmp222*tmp82*tmp86;
REAL8 tmp698=2.*tmp19*tmp43*tmp82*x->data[1];
...
REAL8 tmp829=-12.*tmp222*tmp43*tmp82*x->data[1];
REAL8 tmp830=tmp33*tmp699;
REAL8 tmp831=2.*tmp623*x->data[1];
...
REAL8 tmp837=1.*tmp110*tmp113*tmp117*tmp39*tmp738*x->data[1];
REAL8 tmp838=-(tmp110*tmp113*tmp117*tmp33*tmp57*tmp738*x->data[1]);
