...
REAL8 tmp332=mass2*tmp249;
REAL8 tmp333=coeffs->d1v2*eta*tmp51;
REAL8 tmp334=14.*mass2*tmp249;
...
REAL8 tmp345=-30.*mass2*tmp116*tmp153*tmp197*tmp204*tmp247*tmp249*tmp63;
REAL8 tmp346=3.*tmp11*tmp246*tmp259;
REAL8 tmp347=4.*tmp246*tmp259*tmp338;
REAL8 tmp348=3.*tmp246*tmp281;
REAL8 tmp349=4.*mass2*tmp246*tmp249*tmp281;
...
REAL8 tmp362=-0.013888888888888888*mass2*tmp249*tmp361*tmp53;
