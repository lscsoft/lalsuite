...
REAL8 tmp234=mass2*s1Vec->data[0]*tmp233;
REAL8 tmp235=1/mass2;
REAL8 tmp236=mass1*s2Vec->data[0]*tmp235;
...
REAL8 tmp257=-1440.*tmp185*tmp212*tmp250*tmp252*tmp254*tmp256*tmp63*tmp9;
...
REAL8 tmp276=12.*tmp115*tmp150*tmp194*tmp201*tmp230*tmp273*tmp9;
...
REAL8 tmp281=3240.*tmp185*tmp212*tmp250*tmp252*tmp254*tmp256*tmp63*tmp9;
...
REAL8 tmp297=-12.*tmp115*tmp150*tmp194*tmp201*tmp230*tmp294*tmp9;
REAL8 tmp298=tmp279+tmp280+tmp281+tmp285+tmp289+tmp290+tmp295+tmp296+tmp297;
REAL8 tmp323=mass2*s1Vec->data[1]*tmp233;
REAL8 tmp324=mass1*s2Vec->data[1]*tmp235;
...
REAL8 tmp232=-36.*eta*tmp150*tmp194*tmp201*tmp231*tmp55*tmp63*tmp7*tmp94;
REAL8 tmp238=-30.*eta*tmp150*tmp194*tmp201*tmp231*tmp237*tmp55*tmp63*tmp94;
REAL8 tmp239=36.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp231*tmp63*tmp7;
...
REAL8 tmp242=-60.*tmp115*tmp150*tmp194*tmp201*tmp230*tmp237*tmp9;
REAL8 tmp243=3.*tmp210*tmp230*tmp7;
...
REAL8 tmp299=0.006944444444444444*tmp298*tmp53*tmp7;
REAL8 tmp300=tmp246+tmp278+tmp299;
REAL8 tmp301=1.*tmp21*tmp25*tmp300;
...
REAL8 tmp309=-72.*tmp11*tmp115*tmp150*tmp194*tmp201*tmp230*tmp9;
REAL8 tmp310=-60.*tmp115*tmp150*tmp194*tmp201*tmp230*tmp305*tmp9;
...
REAL8 tmp322=-36.*eta*tmp150*tmp194*tmp201*tmp231*tmp55*tmp63*tmp9*tmp94;
REAL8 tmp326=-30.*eta*tmp150*tmp194*tmp201*tmp231*tmp325*tmp55*tmp63*tmp94;
REAL8 tmp327=36.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp231*tmp63*tmp9;
REAL8 tmp328=30.*tmp115*tmp184*tmp185*tmp194*tmp201*tmp231*tmp325*tmp63;
REAL8 tmp329=-72.*tmp10*tmp115*tmp150*tmp194*tmp201*tmp230;
REAL8 tmp330=-60.*tmp115*tmp150*tmp194*tmp201*tmp230*tmp325*tmp9;
...
REAL8 tmp333=3.*tmp210*tmp230*tmp9;
...
REAL8 tmp439=2.*tmp115*tmp144*tmp149*tmp9;
REAL8 tmp440=tmp436+tmp437+tmp438+tmp439;
REAL8 tmp447=tmp26*tmp300*x->data[0];
REAL8 tmp448=tmp26*tmp317*x->data[2];
REAL8 tmp449=tmp26*tmp359*x->data[1];
REAL8 tmp450=tmp447+tmp448+tmp449;
REAL8 tmp554=coeffs->k5l*tmp91;
REAL8 tmp555=c0k5+tmp554+tmp71+tmp73;
REAL8 tmp527=tmp300*tmp37;
REAL8 tmp528=tmp29*tmp317;
REAL8 tmp529=tmp33*tmp359;
REAL8 tmp530=tmp141*tmp372;
REAL8 tmp531=tmp135*tmp386;
REAL8 tmp532=tmp129*tmp400;
REAL8 tmp533=tmp527+tmp528+tmp529+tmp530+tmp531+tmp532;
REAL8 tmp538=tmp170*tmp300;
REAL8 tmp539=tmp174*tmp317;
REAL8 tmp540=tmp178*tmp359;
REAL8 tmp541=tmp157*tmp372;
REAL8 tmp542=tmp165*tmp386;
...
REAL8 tmp524=2.*tmp115*tmp201*tmp9;
...
REAL8 tmp624=4.*c1k2*tmp9;
REAL8 tmp625=6.*c1k3*tmp9;
...
REAL8 tmp761=-8.*tmp115*tmp230*tmp9;
REAL8 tmp762=2.*tmp577*tmp9;
