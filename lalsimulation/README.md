...
If you make use of the [Python/Octave interfaces to LALSimulation][swiglal],
...
In addition, some codes contained in LALSimulation may be directly based on one
or several scientific papers, which should be cited when using those specific
