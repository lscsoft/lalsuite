...
test_data_inf_v1 = [
    (
        1.3862687342652575e32,
        1.5853186050191907e31,
        0.8768912154180827,
        0.9635416612042661,
        2.8861591668037119,
        2.7423707262813442,
    ...
    (
        4.0380177255695994e31,
        2.1111685497317552e31,
        0.9442047756726544,
        0.2197148251155545,
        2.7060072810080551,
        0.8920951236808333,
    ...
    (
        1.4778236544770486e32,
        2.6197742077777032e31,
        0.4650532384488123,
        0.4135203147241133,
        2.5477872046486589,
        1.3374887745402186,
    ...
    (
        1.4863232012364162e32,
        8.7793565490275959e31,
        0.5893323731604954,
        0.2055055162882128,
        0.6903364245776367,
        1.7543770650607788,
    ...
    (
        1.7178573021561749e32,
        1.4944497411052174e32,
        0.2957920607635095,
        0.4434151999944888,
        2.5141791285526289,
        1.7220573548170679,
    ...
    (
        1.9425515209586304e32,
        1.5834862257761549e32,
        0.2296658494450905,
        0.6534173243439886,
        1.3270660171515838,
        2.8939960781679810,
    ...
    (
        7.6790541604603600e31,
        1.9132537018679275e31,
        0.1199773081324423,
        0.9386480945327058,
        0.5035407043069747,
        1.7892511812390561,
    ...
    (
        1.9825472857867221e32,
        1.4367644552485066e32,
        0.4312785756276836,
        0.5477442096539639,
        1.1515192569867874,
        1.3370105009905482,
    ...
    (
        1.4345358396311136e31,
        1.1150061575178080e31,
        0.6275566268091129,
        0.1660169861331117,
        0.9178548738199007,
        2.8069175353915532,
    ...
    (
        1.2211378968321533e32,
        6.0296417691783719e31,
        0.7112954381378587,
        0.9045511111160647,
        0.0351734285267389,
        2.7472710892536298,
    ...
    (
        1.6081881116676779e32,
        8.5515110662266332e31,
        0.4498334498283801,
        0.4689712388898268,
        3.1415926535897931,
        0.0000000000000000,
    ...
    (
        9.4223304028886096e31,
        2.8099837478253088e31,
        0.5863953401030325,
        0.9151619021800407,
        3.1415926535897931,
        3.1415926535897931,
...
@pytest.mark.parametrize(
    "m1, m2, chi1, chi2, tilt1, tilt2, phi12, fref, tilt1_inf, tilt2_inf, version",
    test_data_inf_v1,
)
def test_inf_v1(
    m1, m2, chi1, chi2, tilt1, tilt2, phi12, fref, tilt1_inf, tilt2_inf, version
    ...
    res = calc_tilts_at_infty_hybrid_evolve(
        m1, m2, chi1, chi2, tilt1, tilt2, phi12, fref, version=version
    )

    rtol = 1.0e-6
    np.testing.assert_allclose(
        [res["tilt1_inf"], res["tilt2_inf"]],
        [tilt1_inf, tilt2_inf],
        err_msg="Check of tilts at infinity failed.",
        rtol=rtol,
    )
