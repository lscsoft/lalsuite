...
\includeonly{std,support,tools,sample,hello,factories,utilities,tdfilters,fft,clremoval,bank,pulsar,fct,findchirp,burstsearch}
...
\begin{itemize}
  ...
  \begin{verbatim}
  \index{{\texttt MyFunction()} You can put a short explanatory string here.}
  \end{verbatim}
  \vspace*{-0.041in}
  ...
  the documentation.  The \verb@\index{}@ command should be right after
  in the section where they are explained in the documentation.  
  Here is an example of the  {\LaTeX} command you would use to get the
  name of your structure into the index.
  \begin{verbatim}
  \index{{\textt MyStruct} You may put a short explanatory string here.}
  \end{verbatim}
\end{itemize}
