...
Creighton, Sam Finn, Albert Lazzarini, Adam Mercer, and Alan Wiseman}
\rcsid$Id$
...
environments.  Specifically this means that routines in \verb+stdio.h+
are not allowed (except for \verb+snprintf+), several routines in
