...
analysis and numerical source modelers to further the science of gravitational
wave astronomy. In this section, we touch upon issues related to the use of
numerical relativity data by the LSC. Together with the numerical community,
the LSC plans to evolve these approches to the use and publication of results
from numerical groups to ensure that: (i) appropriate credit is given for use
of any numerical data and (ii) the providers of the data consent to the way in
