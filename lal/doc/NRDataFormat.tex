...
the LSC plans to evolve a policy on the use and publication of results from
numerical groups to ensure that: (i) appropriate credit is given for use of
any numerical data and (ii) the providers of the data consent to the way in
