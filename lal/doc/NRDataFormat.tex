...
\newcommand*{\Jena}{Theoretical Physics Institute, Uiversity of Jena,
  07743 Jena, Germany}{\affiliation{\Jena}


\title{Data formats for numerical relativity waves}

\author{Duncan Brown}\email{dbrown@ligo.caltech.edu}\affiliation{\CIT}\affiliation{\LIGO}
\author{Stephen Fairhurst}\email{fairhurst_s@ligo.caltech.edu}\affiliation{\CIT}\affiliation{\LIGO}\affiliation{\CU}
\author{Badri Krishnan}\email{badri.krishnan@aei.mpg.de}\affiliation{\AEI}
\author{Adam Mercer}\email{ram@phys.ufl.edu}\affiliation{\UFL}
\author{Kopparapu RaviKumar}\email{kumar@theory.phys.lsu.edu}\affiliation{\LSU}
\author{Lucia Santamaria}\email{lucia.santamaria@uni-jena.de}\affiliation{\Jena}
\author{John Whelan}\email{john.whelan@aei.mpg.de}\affiliation{\AEI}


% \author{Duncan Brown, Stephen Fairhurst, Badri Krishnan, Adam Mercer, 
% Kopparapu RaviKumar, Lucia Santamaria, John Whelan}
...
\begin{abstract}
  ...
  LIGO Scientific Collaboration. The aim is to have a simple format
  which is nevertheless sufficiently general, and is applicable to
  various kinds of sources including binaries of compact objects and
  systems undergoing gravitational collapse.
\end{abstract}
...
Numerical relativity has made enormous progress within the last few years.
Many numerical relativity groups now have sufficiently stable and
accurate codes which can simulate the inspiral, merger, and
...
We are grateful to various numerical relativists for valuable
discussions and suggestions.  In particular, we would like to thank
Harald Pfeiffer, Erik Schnetter, Luis Lehner, Lee Lindblom, Luciano
Rezzolla, Peter Diener, Pablo Laguna, Deirdre Shoemaker, Manuela
Campanelli, Carlos Lousto, Sascha Husa,....
