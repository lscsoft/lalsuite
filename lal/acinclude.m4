...
[AC_ARG_WITH(
        ...
        [ if test -n "${with_gcc_flags}"
          then
            lal_gcc_flags="-g3 -O4 -ansi -Werror -Wall -W -Wmissing-prototypes -Wstrict-prototypes -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Waggregate-return -fshort-enums -fno-common -Wnested-externs -D__NO_STRING_INLINES"
          else
            lal_gcc_flags=""
          fi
        ], [ lal_gcc_flags="" ] )
