...
DEFINE_VECTORMATH_SS2S(Add, _mm_add_ps)
DEFINE_VECTORMATH_SS2S(Multiply, _mm_mul_ps)
...
DEFINE_VECTORMATH_sS2S(Shift, _mm_add_ps)
DEFINE_VECTORMATH_sS2S(Scale, _mm_mul_ps)
