...
#define UVAR_FMT                                "`--%s'"
#define UVAR_STR(n)                             "`--"n"'"
#define UVAR_STR2(conj,n1,n2)                   "`--"n1"' "conj" `--"n2"'"
#define UVAR_STR3(conj,n1,n2,n3)                "`--"n1"', `--"n2"', "conj" `--"n3"'"
#define UVAR_STR4(conj,n1,n2,n3,n4)             "`--"n1"', `--"n2"', `--"n3"', "conj" `--"n4"'"
#define UVAR_STR5(conj,n1,n2,n3,n4,n5)          "`--"n1"', `--"n2"', `--"n3"', `--"n4"', "conj" `--"n5"'"
/*@}*/
