...
enum {
	LAL_TAMA_300_DETECTOR_BIT	=	1L << 2 * LAL_TAMA_300_DETECTOR,
	LAL_VIRGO_DETECTOR_BIT   	=	1L << 2 * LAL_VIRGO_DETECTOR,
	LAL_GEO_600_DETECTOR_BIT 	=	1L << 2 * LAL_GEO_600_DETECTOR,
	LAL_LHO_2K_DETECTOR_BIT  	=	1L << 2 * LAL_LHO_2K_DETECTOR,
	LAL_LHO_4K_DETECTOR_BIT  	=	1L << 2 * LAL_LHO_4K_DETECTOR,
	LAL_LLO_4K_DETECTOR_BIT  	=	1L << 2 * LAL_LLO_4K_DETECTOR,
	LAL_CIT_40_DETECTOR_BIT  	=	1L << 2 * LAL_CIT_40_DETECTOR,
	LAL_ALLEGRO_DETECTOR_BIT 	=	1L << 2 * LAL_ALLEGRO_DETECTOR,
	LAL_AURIGA_DETECTOR_BIT  	=	1L << 2 * LAL_AURIGA_DETECTOR,
	LAL_NIOBE_DETECTOR_BIT   	=	1L << 2 * LAL_NIOBE_DETECTOR,
	LAL_NAUTILUS_DETECTOR_BIT	=	1L << 2 * LAL_NAUTILUS_DETECTOR,
	LAL_ET1_DETECTOR_BIT     	=	1L << 2 * LAL_ET1_DETECTOR,
	LAL_ET2_DETECTOR_BIT     	=	1L << 2 * LAL_ET2_DETECTOR,
	LAL_ET3_DETECTOR_BIT     	=	1L << 2 * LAL_ET3_DETECTOR,
	LAL_ET0_DETECTOR_BIT     	=	1L << 2 * LAL_ET0_DETECTOR,
	LAL_KAGRA_DETECTOR_BIT     	=	1L << 2 * LAL_KAGRA_DETECTOR
};
