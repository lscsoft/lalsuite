...
[AC_ARG_WITH(
        ...
        [ if test -n "${with_gcc_flags}"
          then
            lal_gcc_flags="-g3 -O4 -ansi -pedantic-errors -Wall -W -Wmissing-prototypes -Wstrict-prototypes -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -fno-common -Wnested-externs -D__NO_STRING_INLINES -Wno-long-long"
          else
            lal_gcc_flags=""
          fi
        ], [ lal_gcc_flags="" ] )
