/************************** <lalVerbatim file="GeneratePPNAmpTruncInspiralCV">
...
\subsection{Module \texttt{GeneratePPNAmpTruncInspiral.c}}
\label{ss:GeneratePPNAmpTruncInspiral.c}
...
\vspace{0.1in}
\input{GeneratePPNAmpTruncInspiralCP}
\idx{LALGeneratePPNAmpTruncInspiral()}

\subsubsection*{Description}

See GeneratePPNAmpTruncInspiral.c
...
\vfill{\footnotesize\input{GeneratePPNAmpTruncInspiralCV}}
...
NRCSID( GENERATEPPNAMPTRUNCINSPIRALC, "$Id$" );
...
#define LAL_THETA (-11831.0/9240.0) /* Regularization constant */
#define LAL_LAMBDA (-1987.0/3080.0) /* Another regularization constant */
...
/* <lalVerbatim file="GeneratePPNAmpTruncInspiralCP"> */
void
...
{ /* </lalVerbatim> */
  ...
  REAL4 g0, g1, g2, g3, g4, g5, g6, g7;   /* PN t(f) coefficients */
  ...
  /* Truncated expressions and their expansion coefficients */
  REAL4 v2tr, v3tr, v4tr, v5tr, v6tr, v7tr;  /* Truncated expressions in orbital velocity */
  
  REAL4 v2tr2, v2tr3, v2tr4, v2tr5; /* coefficients and Newtonian prefactor */
  REAL4 v3tr2, v3tr3, v3tr4, v3tr5;
  REAL4 v4tr2, v4tr3, v4tr4, v4tr5;
  REAL4 v5tr2, v5tr3, v5tr4, v5tr5;
  REAL4 v6tr2, v6tr3, v6tr4, v6tr5;
  REAL4 v7tr2, v7tr3, v7tr4, v7tr5;
  REAL4 vtrFac;
  ...
  INITSTATUS( stat, "LALGeneratePPNAmpTruncInspiral", GENERATEPPNAMPTRUNCINSPIRALC );
  ...
  /* Coefficients for truncated expressions */
  v2tr2 = 743.0/4032.0 + 11.0/48.0*eta;
  v2tr3 = -1.0/5.0*LAL_PI;
  v2tr4 = 19583.0/254016.0 + 24401.0/193536.0*eta + 31.0/288.0*eta*eta;
  v2tr5 = (- 11891.0/53760.0 + 109.0/1920.0*eta)*LAL_PI;  

  v3tr2 = 743.0/2688.0 + 11.0/32.0*eta;
  v3tr3 = - 3.0/10.0*LAL_PI;
  v3tr4 = 1855099.0/14450688.0 + 56975.0/258048.0*eta + 371.0/2048.0*eta*eta;
  v3tr5 = -7729.0/21504.0*LAL_PI + 13.0/256.0*LAL_PI*eta;
  
  v4tr2 = 743.0/2016.0 + 11.0/24.0*eta;
  v4tr3 = - 2.0/5.0*LAL_PI;
  v4tr4 = 3058673.0/16257024.0 + 5429.0/16128.0*eta + 617.0/2304.0*eta*eta;
  v4tr5 = (- 41617.0/80640.0 + 7.0/320.0*eta)*LAL_PI;  
 
  v5tr2 = 3715.0/8064.0 + 55.0/96.0*eta;
  v5tr3 = - 1.0/2.0*LAL_PI;
  v5tr4 = 3346975.0/130056192.0 + 366605.0/774144.0*eta + 6775.0/18432.0*eta*eta;
  v5tr5 = - (14863.0/21504.0 + 23.0/768.0*eta)*LAL_PI;

  v6tr2 = 743.0/1344.0 + 11.0/16.0*eta;
  v6tr3 = - 3.0/5.0*LAL_PI;
  v6tr4 = 601787.0/1806336.0 + 5821.0/9216.0*eta + 123.0/256.0*eta*eta;
  v6tr5 = - (47561.0/53760.0 + 67.0/640.0*eta)*LAL_PI;

  v7tr2 = 743.0/1152.0 + 77.0/96.0*eta;
  v7tr3 = - 7.0/10.0*LAL_PI;
  v7tr4 = 1110499.0/2654208.0 + 3321.0/4096.0*eta + 11179.0/18432.0*eta*eta;
  v7tr5 = - (50533.0/46080.0 + 259.0/1280.0*eta)*LAL_PI;
  ...
  */
  ...
  while ( 1 ) {
     ...
     *(phi++) = phiC - phase;
     ...
     /* PLUS */
     a1 = q[1]*a1Pthree*v3tr + q[3]*a1Pfive*v5tr + q[4]*a1Psix*v6tr + q[5]*a1Pseven*v7tr;  
     a1mix = q[4]*a1Pmix*v6tr;
       
     a2 = q[0]*a2Ptwo*v2tr + q[2]*a2Pfour*v4tr + q[3]*a2Pfive*v5tr + q[4]*a2Psix*v6tr + q[5]*a2Pseven*v7tr;		 
     a2mix = q[5]*a2Pmix*v7tr;      	       
       
     a3 = q[1]*a3Pthree*v3tr + q[3]*a3Pfive*v5tr + q[4]*a3Psix*v6tr + q[5]*a3Pseven*v7tr;		
     a3mix = q[4]*a3Pmix*v6tr;	       
     
     a4 = q[2]*a4Pfour*v4tr + q[4]*a4Psix*v6tr + q[5]*a4Pseven*v7tr; 
     a4mix = q[5]*a4Pmix*v7tr;      
     
     a5 = q[3]*a5Pfive*v5tr + q[5]*a5Pseven*v7tr;	    
     
     a6 = q[4]*a6Psix*v6tr;
     
     a7 = q[5]*a7Pseven*v7tr;     
 ...
 /* CROSS */
     a1 = q[1]*a1Cthree*v3tr + q[3]*a1Cfive*v5tr + q[4]*a1Csix*v6tr;         	     
     a1mix = q[4]*a1Cmixsix*v6tr + q[5]*a1Cmixseven*v7tr;    
       
     a2 = q[0]*a2Ctwo*v2tr + q[2]*a2Cfour*v4tr + q[3]*a2Cfive*v5tr + q[4]*a2Csix*v6tr + q[5]*a2Cseven*v7tr;    
     a2mix = q[5]*a2Cmix*v7tr;
     
     a3 = q[1]*a3Cthree*v3tr + q[3]*a3Cfive*v5tr + q[4]*a3Csix*v6tr + q[5]*a3Cseven*v7tr;   
     a3mix = q[4]*a3Cmix*v6tr;
     
     a4 = q[2]*a4Cfour*v4tr + q[4]*a4Csix*v6tr + q[5]*a4Cseven*v7tr;
     a4mix = q[5]*a4Cmix*v7tr;  
     
     a5 = q[3]*a5Cfive*v5tr + q[5]*a5Cseven*v7tr;
     
     a6 = q[4]*a6Csix*v6tr;
     
     a7 = q[5]*a7Cseven*v7tr;     
