...
main( int argc, char **argv )
{
  ...
  SETGPSCASE( "-722345678.5133", -722345678, -513300000, "" );
  SETGPSCASE( "-73234567800.5233", (INT4) (-LAL_INT4_ABSMIN), -999999999, "" );
  SETGPSCASE( "-742345678.9999999994", -742345678, -999999999, "" );
