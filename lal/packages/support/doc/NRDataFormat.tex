...
propagation of the wave.  Thus, $\mathbf{e}_{z^\prime} = \cos\iota
 \mathbf{e}_z + \sin\iota\cos\phi \mathbf{e}_x +
\sin\iota\sin\phi \mathbf{e}_y$. There is a freedom in choosing
...
\begin{equation}
  \label{eq:8}
  \mathbf{e}_{x^\prime} =
  \frac{\mathbf{e}_{z^\prime}\times\mathbf{e}_z}{||\mathbf{e}_{z^\prime}\times\mathbf{e}_z||} \,, 
  \qquad \textrm{and} \qquad 
  \mathbf{e}_{z^\prime} = \mathbf{e}_{x^\prime} \times \mathbf{e}_{y^\prime} \,.
\end{equation}
...
\end{equation}
where $\mathbf{e}_+$ and $\mathbf{e}_\times$ are the usual basis tensors for
transverse-traceless tensors in the wave frame
\begin{equation}
  \label{eq:9}
  \mathbf{e}_+ = \mathbf{e}_{x^\prime}\otimes\mathbf{e}_{x^\prime} -
  \mathbf{e}_{y^\prime}\otimes\mathbf{e}_{y^\prime}\,, \qquad \textrm{and} \qquad 
  \mathbf{e}_+ = \mathbf{e}_{x^\prime}\otimes\mathbf{e}_{y^\prime} +
  \mathbf{e}_{y^\prime}\otimes\mathbf{e}_{x^\prime}\,. 
\end{equation}
