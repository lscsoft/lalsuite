 ...
 *
 * The LICENCE.txt and README (renamed snprintf_LICENCE.txt and
 * snprintf_README) are included in this directory for reference.
 */

/*
 * These are the appropriate options for LAL.
 */

#define portable_snprintf LALSnprintf           /* LAL naming convension */
#define portable_vsnprintf LALVsnprintf         /* LAL naming convension */
#ifndef HAVE_SNPRINTF
#define HAVE_SNPRINTF           /* don't rename portable_snprintf        */
                                /* (since it is done above)...           */
#endif
#define PREFER_PORTABLE_SNPRINTF/* ...but use this implementation        */
#undef NEED_SNPRINTF_ONLY       /* want vsnprintf too                    */

/*
 * The rest of the code is incorporated from Mark Martinec's distribution.
 * This code is unmodified except in five cases where a cast is used to
 * avoid "warning: comparison between signed and unsigned" messages
 */
