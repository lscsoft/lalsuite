...
int main(void)
{
	struct TESTCASE testcases[] = {
		...
		{"00000000712346678", 15022519, 0, "8", 0}, /* originally {"00000000712346678", 712346678, 0, ""}, (should be parsed as base 8) */
		{"000000000000000000000000000000000712347678", 15022583, 0, "8", 0}, /* originally {"000000000000000000000000000000000712347678", 712347678, 0, ""}, (should be parsed as base 8 )*/
		{"000000000000000000712348678.00000000000000", 29340, 0, "8678.00000000000000", 0}, /* originally {"000000000000000000712348678.00000000000000", 712348678, 0, ""}, (should be parsed as base 8) */
		{"000000000000000000712349678.00000000000001", 29340, 0, "9678.00000000000001", 0}, /* originally {"000000000000000000712349678.00000000000001", 712349678, 0, ""}, (should be parsed as base 8) */
		{"722345678.", 722345678, 0, "", 0},
		{"1722346678.", 1722346678, 0, "", 0},
		{"01722347678.", 32061943, 0, "8.", 0}, /* originally {"01722347678.", 1722347678, 0, ""}, (should be parsed as base 8) */
		{"001722348678.", 62620, 0, "8678.", 0}, /* originally {"001722348678.", 1722348678, 0, ""}, (should be parsed as base 8) */
		...
		{"7323456785", LONG_MAX, 0, "", XLAL_ERANGE}, /* originally {"7323456785", INT_MAX, 999999999, ""}, (function reports range error, output of parser irrelevant) */
		{"7423456785234", LONG_MAX, 0, "", XLAL_ERANGE}, /* originally {"7423456785234", INT_MAX, 999999999, ""}, (function reports range error, output of parser irrelevant) */
		...
		{"752345678.5433e258", LONG_MAX, 0, "", XLAL_ERANGE}, /* originally {"752345678.5433e258", INT_MAX, 999999999, ""}, (function reports range error, result irrelevant) */
		{"762345678.5533e258r574", LONG_MAX, 0, "r574", XLAL_ERANGE}, /* originally {"762345678.5533e258r574", INT_MAX, 999999999, "r574"}, (function returns range error, result irrelevant) */
		...
		{"-744345678.9999999995", -744345678, -999999999, "", 0}, /* originally {"-744345678.9999999995", -744345679, 0, ""}, (rounding corrected) */
