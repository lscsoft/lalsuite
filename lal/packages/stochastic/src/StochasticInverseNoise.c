...
/* </lalVerbatim> */
{
  ...
  ASSERT( input != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );

  /* check that pointer to output structure is not null */
  ASSERT( output != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );
 
  /* check that pointers to members of input structure are not null */
  wNoise      = input->whitenedNoisePSD;
  ASSERT( wNoise != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  wFilter     = input->whiteningFilter;
  ASSERT( wFilter != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );

  /* check that pointers to members of output structure are not null */
  invNoise    = output->unWhitenedInverseNoisePSD;
  ASSERT( invNoise != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  hwInvNoise  = output->halfWhitenedInverseNoisePSD;
  ASSERT( hwInvNoise != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  
  /* check that pointers to data members of series are not null */
  ASSERT( wNoise->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  ASSERT( wFilter->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  ASSERT( invNoise->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  ASSERT( hwInvNoise->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );

  /* check that pointers to data-data members of series are not null */
  ASSERT( wNoise->data->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  ASSERT( wFilter->data->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );  
  ASSERT( invNoise->data->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
  ASSERT( hwInvNoise->data->data != NULL, status, STOCHASTICCROSSCORRELATIONH_ENULLP, 
          STOCHASTICCROSSCORRELATIONH_MSGENULLP );
