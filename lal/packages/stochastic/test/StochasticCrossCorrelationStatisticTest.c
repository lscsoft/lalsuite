/****************** <lalVerbatim file="StochasticCrossCorrelationStatisticTestCV">
Author: UTB Relativity Group; contact J. T. Whelan (original by S. Drasco)
$Id$
********************************* </lalVerbatim> */

/********************************************************** <lalLaTeX>
\subsection{Program \texttt{StochasticCrossCorrelationStatisticTest.c}}
\label{stochastic:ss:StochasticCrossCorrelationStatisticTest.c}

A program to test \texttt{LALStochasticCrossCorrelationStatistic()}.
...
\texttt{LALStochasticCrossCorrelationStatistic()}, which calculates
...
\input{StochasticCrossCorrelationStatisticTestCE}
...
\vfill{\footnotesize\input{StochasticCrossCorrelationStatisticTestCV}}
...
#define STOCHASTICCROSSCORRELATIONSTATISTICTESTC_TOL       1e-5
...
/*********** <lalErrTable file="StochasticCrossCorrelationStatisticTestCE"> */
...
int main( int argc, char *argv[] )
{
  ...
  if ( ! lalNoDebug )
  {
    ...
    LALStochasticCrossCorrelationStatistic(&status, NULL, &input);
    ...
    LALStochasticCrossCorrelationStatistic(&status, &output, NULL);
    if ( code = CheckStatus(&status, STOCHASTICCROSSCORRELATIONH_ENULLP,
                            STOCHASTICCROSSCORRELATIONH_MSGENULLP,
                            STOCHASTICCROSSCORRELATIONSTATISTICTESTC_ECHK,
                            STOCHASTICCROSSCORRELATIONSTATISTICTESTC_MSGECHK)) 
...
ParseOptions (int argc, char *argv[])
{
  while (1)
  {
    ...
    c = getopt (argc, argv, "hqvd:i:j:k:n:");
    if (c == -1)
    {
      break;
    }
