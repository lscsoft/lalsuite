...
\index{\texttt{COMPLEX8TimeFrequencyPlane}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\index{\texttt{VerticalTFTransformIn}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\index{\texttt{HorizontalTFTransformIn}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\index{\texttt{LALCreateRealDFTParams()}}
...
\index{\texttt{LALDestroyRealDFTParams()}}
...
\index{\texttt{LALCreateComplexDFTParams()}}
...
\index{\texttt{LALDestroyComplexDFTParams()}}
...
\index{\texttt{LALComputeFrequencySeries()}}
...
\index{\texttt{LALTimeSeriesToTFPlane()}}
...
\index{\texttt{LALFreqSeriesToTFPlane()}}
...
\index{\texttt{ComputeExcessPowerIn}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\index{\texttt{LALCreateTFTiling()}}

\subsubsection*{Description}

The routine \verb+CreateTFTiling()+ takes as input a pointer \verb+input+ to a
data structure of type \verb+CreateTFTilingIn+, which consists of the
following elements.

The routine \verb+CreateTFTiling()+ has an
input/output parameter \verb+tfTiling+ of type \verb+TFTiling**+.  On exit
from \verb+CreateTFTiling+, the pointer \verb+*tfTiling+ will point to the
newly created \verb+TFTiling+ structure.  The routine \verb+CreateTFTiling+
also assigns memory for and creates the $p+1$ time frequency planes and the
$p+1$ \verb+ComplexDFTParams+ structures, and the linked list of TF tiles.
...
\index{\texttt{LALDestroyTFTiling()}}
...
\index{\texttt{LALComputeTFPlanes()}}
...
\index{\texttt{LALComputeExcessPower()}}
...
\subsubsection*{Prototypes}
\vspace{0.1in}
\input{CountEPEventsCP}
\index{\texttt{LALCountEPEvents()}}
...
\vfill{\footnotesize\input{CountEPEventsCV}}
...
\index{\texttt{LALPrintTFTileList()}}
...
\index{\texttt{LALComputeLikelihood()}}
...
\vspace{0.1in}
\input{ChisqCdfP}
\index{\texttt{LALChisqCdf()}}
\input{OneMinusChisqCdfP}
\index{\texttt{LALOneMinusChisqCdf()}}
\input{NoncChisqCdfP}
\index{\texttt{LALNoncChisqCdf()}}
\input{Chi2ThresholdP}
\index{\texttt{LALChi2Threshold()}}
\input{RhoThresholdP}
\index{\texttt{LALRhoThreshold()}}
