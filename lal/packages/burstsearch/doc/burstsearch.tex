...
\subsubsection*{Prototypes}
\vspace{0.1in}
\input{LALWeighTFTileListCP}
\idx{LALWeighTFTileList()}
\input{EPInitSearchCP}
\idx{EPInitSearch()}
\input{EPConditionDataCP}
\idx{EPConditionData()}
\input{EPFinalizeSearchCP}
\idx{EPFinalizeSearch()}
\input{EPSearchCP}
\idx{EPSearch()}
