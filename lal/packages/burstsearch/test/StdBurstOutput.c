...
INT4 main(INT4 argc, CHAR *argv[]) {
  ...
  while(optr) {
    ...
    if(optr->snglTransdataTable) {
      ...
      printf("%s %s\t%s\t%u\t%u\t%g\t%g\t%g\t%g\t%g\t%g\t1\n",ooptr->snglBurstTable->ifo, ooptr->snglBurstTable->search, ooptr->snglBurstTable->channel, ooptr->snglBurstTable->start_time.gpsSeconds, ooptr->snglBurstTable->start_time.gpsNanoSeconds, ooptr->snglBurstTable->duration, ooptr->snglBurstTable->central_freq, ooptr->snglBurstTable->bandwidth,ooptr->snglBurstTable->snr,ooptr->snglBurstTable->amplitude,ooptr->snglBurstTable->confidence);
      printf("%s %s\t%s\t%u\t%u\t%g\t%g\t%g\t%g\t%g\t%g\t1\n",optr->snglBurstTable->ifo, optr->snglBurstTable->search, optr->snglBurstTable->channel, optr->snglBurstTable->start_time.gpsSeconds, optr->snglBurstTable->start_time.gpsNanoSeconds, optr->snglBurstTable->duration, optr->snglBurstTable->central_freq, optr->snglBurstTable->bandwidth,optr->snglBurstTable->snr,optr->snglBurstTable->amplitude,optr->snglBurstTable->confidence);
      printf("***************************************************\n");
	...
	printf("%u\t%u\t%g\n", ti, fi, P);
      ...
      printf("%s %s\t%s\t%u\t%u\t%g\t%g\t%g\t%g\t%g\t%g\t0\n",ooptr->snglBurstTable->ifo, ooptr->snglBurstTable->search, ooptr->snglBurstTable->channel, ooptr->snglBurstTable->start_time.gpsSeconds, ooptr->snglBurstTable->start_time.gpsNanoSeconds, ooptr->snglBurstTable->duration, ooptr->snglBurstTable->central_freq, ooptr->snglBurstTable->bandwidth,ooptr->snglBurstTable->snr,ooptr->snglBurstTable->amplitude,ooptr->snglBurstTable->confidence);
      printf("%s %s\t%s\t%u\t%u\t%g\t%g\t%g\t%g\t%g\t%g\t0\n",optr->snglBurstTable->ifo, optr->snglBurstTable->search, optr->snglBurstTable->channel, optr->snglBurstTable->start_time.gpsSeconds, optr->snglBurstTable->start_time.gpsNanoSeconds, optr->snglBurstTable->duration, optr->snglBurstTable->central_freq, optr->snglBurstTable->bandwidth,optr->snglBurstTable->snr,optr->snglBurstTable->amplitude,optr->snglBurstTable->confidence);
      printf("***************************************************\n");
    }
