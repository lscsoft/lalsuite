...
cmd = "./.libs/NewGetAMCoeffsTest >> amCoeffsTest.dat";
...
## avgerr01
hist ( res(:,4), 100 );		
title ("Average error 0 - 1");
plot2eps ( "avgerr_01.eps");

## avgerr02
hist ( res(:,5), 100 );		
title ("Average error 0 - 2");
plot2eps ( "avgerr_02.eps");

## avgerr12
hist ( res(:,6), 100 );		
title ("Average error 1 - 2");
plot2eps ( "avgerr_12.eps");

## maxerr01
hist ( res(:,7), 100 );		
title ("Maximal error 0 - 1");
plot2eps ( "maxerr_01.eps");

## maxerr02
hist ( res(:,8), 100 );		
title ("Maximal error 0 - 2");
plot2eps ( "maxerr_02.eps" );

## maxerr12
hist ( res(:,9), 100 );		
title ("Maximal error 1 - 2");
