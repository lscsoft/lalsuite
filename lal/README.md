...
If you make use of the [Python/Octave interfaces to LAL][swiglal], please cite
the following paper:
...
In addition, some codes contained in LAL may be directly based on one or several
scientific papers, which should be cited when using those specific codes; some
of these can be discovered through the documentation.
