...
def ExcessPowerBailoutFunc(a, b):
    ...
    cluster.
    """
    return (a.ifo, a.channel, a.search) != (
        b.ifo,
        b.channel,
        b.search,
    ) or a.period.disjoint(b.period)
...
def ExcessPowerTestFunc(a, b):
    ...
    """
    return (
        (a.ifo, a.channel, a.search) != (b.ifo, b.channel, b.search)
        or a.period.disjoint(b.period)
        or a.band.disjoint(b.band)
    )
...
def ExcessPowerClusterFunc(a, b):
    ...
    a.ms_period = snglcluster.weighted_average_seg(
        a.ms_period, a.snr**2.0, b.ms_period, b.snr**2.0
    )
    a.ms_band = snglcluster.weighted_average_seg(
        a.ms_band, a.snr**2.0, b.ms_band, b.snr**2.0
    )
    ...
    a.peak_time = (a.snr**2.0 * a.peak_time + b.snr**2.0 * b.peak_time) / (
        a.snr**2.0 + b.snr**2.0
    )
    a.peak_frequency = (
        a.snr**2.0 * a.peak_frequency + b.snr**2.0 * b.peak_frequency
    ) / (a.snr**2.0 + b.snr**2.0)
...
def bucluster(
    ...
    try:
        ...
        if verbose:
            print(
                "document does not contain a sngl_burst table, skipping ...",
                file=sys.stderr,
            )
        return xmldoc, False
    seglists = ligolw_search_summary.segmentlistdict_fromsearchsummary_out(
        xmldoc, program=program
    ).coalesce()
    ...
    table_changed = snglcluster.cluster_events(
        sngl_burst_table,
        testfunc,
        clusterfunc,
