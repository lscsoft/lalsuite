...
ExcessPowerSBBCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=1,
    description="sim_burst<-->sngl_burst coincidences",
)
ExcessPowerSIBCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=4,
    description="sim_inspiral<-->sngl_burst coincidences",
)
ExcessPowerSBCCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=2,
    description="sim_burst<-->coinc_event coincidences (exact)",
)
ExcessPowerSBCNearCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=3,
    description="sim_burst<-->coinc_event coincidences (nearby)",
)
ExcessPowerSICCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=5,
    description="sim_inspiral<-->coinc_event coincidences (exact)",
)
ExcessPowerSICNearCoincDef = lsctables.CoincDef(
    search="excesspower",
    search_coinc_type=6,
    description="sim_inspiral<-->coinc_event coincidences (nearby)",
)


StringCuspSBBCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=1,
    description="sim_burst<-->sngl_burst coincidences",
)
StringCuspSIBCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=4,
    description="sim_inspiral<-->sngl_burst coincidences",
)
StringCuspSBCCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=2,
    description="sim_burst<-->coinc_event coincidences (exact)",
)
StringCuspSBCNearCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=3,
    description="sim_burst<-->coinc_event coincidences (nearby)",
)
StringCuspSICCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=5,
    description="sim_inspiral<-->coinc_event coincidences (exact)",
)
StringCuspSICNearCoincDef = lsctables.CoincDef(
    search="StringCusp",
    search_coinc_type=6,
    description="sim_inspiral<-->coinc_event coincidences (nearby)",
)
...
OmegaBBCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=0,
    description="sngl_burst<-->sngl_burst coincidences",
)
OmegaSBBCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=1,
    description="sim_burst<-->sngl_burst coincidences",
)
OmegaSIBCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=4,
    description="sim_inspiral<-->sngl_burst coincidences",
)
OmegaSBCCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=2,
    description="sim_burst<-->coinc_event coincidences (exact)",
)
OmegaSBCNearCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=3,
    description="sim_burst<-->coinc_event coincidences (nearby)",
)
OmegaSICCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=5,
    description="sim_inspiral<-->coinc_event coincidences (exact)",
)
OmegaSICNearCoincDef = lsctables.CoincDef(
    search="omega",
    search_coinc_type=6,
    description="sim_inspiral<-->coinc_event coincidences (nearby)",
)

CWBBBCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=0,
    description="sngl_burst<-->sngl_burst coincidences",
)
CWBSBBCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=1,
    description="sim_burst<-->sngl_burst coincidences",
)
CWBSIBCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=4,
    description="sim_inspiral<-->sngl_burst coincidences",
)
CWBSBCCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=2,
    description="sim_burst<-->coinc_event coincidences (exact)",
)
CWBSBCNearCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=3,
    description="sim_burst<-->coinc_event coincidences (nearby)",
)
CWBSICCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=5,
    description="sim_inspiral<-->coinc_event coincidences (exact)",
)
CWBSICNearCoincDef = lsctables.CoincDef(
    search="waveburst",
    search_coinc_type=6,
    description="sim_inspiral<-->coinc_event coincidences (nearby)",
)
...
class DocContents(object):
    ...
    def __init__(
        ...
        try:
            b_b_coinc_def_id = ligolw_coincs.get_coinc_def_id(
                xmldoc, b_b_def.search, b_b_def.search_coinc_type, create_new=False
            )
        except KeyError:
        ...
        self.snglbursttable = dict(
            (
                instrument,
                sorted(
                    (event for event in self.snglbursttable if event.ifo == instrument),
    ...
    def bursts_near_peaktime(self, t, window, offsetvector):
        ...
        return sum(
            (
                events[
                    bisect.bisect_left(
                        events, t - offsetvector[instrument] - window
                    ) : bisect.bisect_right(
                        events, t - offsetvector[instrument] + window
                    )
                ]
                for instrument, events in self.snglbursttable.items()
            ),
            [],
        )
    ...
    def coincs_near_peaktime(self, t, window, offsetvector):
        ...
        return [
            (coinc_event_id, events)
            for coinc_event_id, events in self.coincs
            if set(events) & near_events
            and offsetvector.contains(self.coincoffsets[coinc_event_id])
        ]
...
def StringCuspSnglCompare(sim, burst, offsetvector):
    ...
    return segments.segment(tinj - window, tinj + window).disjoint(
        burst.period
    )  # or abs(sim.amplitude / SimBurstUtils.string_amplitude_in_instrument(sim, burst.ifo, offsetvector)) > 3
...
def ExcessPowerSnglCompare(sim, burst, offsetvector):
    ...
    """
    return (sim.time_at_instrument(burst.ifo, offsetvector) not in burst.period) or (
        sim.frequency not in burst.band
    )
...
def OmegaSnglCompare(sim, burst, offsetvector, delta_t=10.0):
    ...
    """
    return (
        abs(float(sim.time_at_instrument(burst.ifo, offsetvector) - burst.peak))
        > delta_t
    )
...
def StringCuspNearCoincCompare(sim, burst, offsetvector):
    ...
    tinj = sim.time_at_instrument(burst.ifo, offsetvector)
    window = (
        SimBurstUtils.stringcusp_autocorrelation_width / 2
        + SimBurstUtils.burst_is_near_injection_window
    )
...
def find_sngl_burst_matches(contents, sim, comparefunc, sieve_window):
    ...
    return [
        burst
        for burst in contents.bursts_near_peaktime(
            sim.time_geocent, sieve_window, offsetvector
        )
        if not comparefunc(sim, burst, offsetvector)
    ]
...
def find_exact_coinc_matches(coincs, sim, comparefunc, seglists, offsetvector):
    ...
    return set(
        coinc_event_id
        for coinc_event_id, events in coincs
...
def find_near_coinc_matches(coincs, sim, comparefunc, offsetvector):
    ...
    return set(
        coinc_event_id
        for coinc_event_id, events in coincs
        if not all(comparefunc(sim, event, offsetvector) for event in events)
    )
...
def binjfind(
    xmldoc, process, search, snglcomparefunc, nearcoinccomparefunc, verbose=False
):
    #
    ...
    coinc_peak_time_window = (
        burst_peak_time_window + SimBurstUtils.burst_is_near_injection_window
    )
    ...
    if contents.simbursttable is not None:
        ...
        for n, sim in enumerate(contents.simbursttable):
            ...
            events = find_sngl_burst_matches(
                contents, sim, snglcomparefunc, burst_peak_time_window
            )
            if events:
        ...
        if verbose:
            print(
                "constructing %s and %s:"
                % (sb_c_e_def.description, sb_c_n_def.description),
                file=sys.stderr,
            )
        for n, sim in enumerate(contents.simbursttable):
            if verbose:
                print("\t%.1f%%\r" % (100.0 * n / N), end=" ", file=sys.stderr)
            offsetvector = contents.offsetvectors[sim.time_slide_id]
            coincs = contents.coincs_near_peaktime(
                sim.time_geocent, coinc_peak_time_window, offsetvector
            )
            exact_coinc_event_ids = find_exact_coinc_matches(
                coincs, sim, snglcomparefunc, contents.seglists, offsetvector
            )
            near_coinc_event_ids = find_near_coinc_matches(
                coincs, sim, nearcoinccomparefunc, offsetvector
            )
            assert exact_coinc_event_ids.issubset(near_coinc_event_ids)
            if exact_coinc_event_ids:
                add_sim_coinc_coinc(
                    contents, sim, exact_coinc_event_ids, contents.sb_c_e_coinc_def_id
                )
        ...
        print(
            "no %s table in document, skipping" % lsctables.SimBurstTable.tableName,
            file=sys.stderr,
        )
    ...
    if contents.siminspiraltable is not None:
        ...
        if verbose:
            print(
                "constructing %s and %s:"
                % (si_c_e_def.description, si_c_n_def.description),
                file=sys.stderr,
            )
        for n, sim in enumerate(contents.siminspiraltable):
            if verbose:
            ...
            if exact_coinc_event_ids:
                add_sim_coinc_coinc(
                    contents, sim, exact_coinc_event_ids, contents.si_c_e_coinc_def_id
                )
            if near_coinc_event_ids:
                add_sim_coinc_coinc(
        ...
        print(
            "no %s table in document, skipping" % lsctables.SimInspiralTable.tableName,
            file=sys.stderr,
        )
