 ...
 * will be allocated by this function.  No time shifts are applied, the
 * "time" of the injection generated by this function corresponds to the
 * sample at t=0 in the resultant time series.  The time-at-geocentre and
 * the time shift offset must be applied separately.  delta_t is the sample
